		...
		<div id="main">
			...
			<div style="float:right; width:560px;">
				...
				<table width="450" align="center" cellpadding="0" cellspacing="3" >
					<tr>
						<td>
							<button  onClick="requestCall('Wednesday')" type="submit" name="Wednesday" id="Wednesday" value="clicked" style="width:162px; height: 57px; background: url(/admission/images/buttons.png); color: navy; font-family: Tahoma, Arial, Verdana, Geneva, sans-serif; font-size:13px; line-height: 19px; font-weight:bold; cursor:pointer; border: 1px outset buttonface">
							Sign me up for a<br>Wednesday call
							</button></td>
						<td>
							<button onClick="requestCall('Thursday')" type="submit" name="Thursday" id="Thursday" value="clicked" style="width:162px; height: 57px; background: url(/admission/images/buttons.png); color: navy; font-family: Tahoma, Arial, Verdana, Geneva, sans-serif; font-size:13px; line-height: 19px; font-weight:bold; cursor:pointer; border: 1px outset buttonface">
							Sign me up for a<br>Thursday call
							</button></td>
					</tr>
					<tr>
						<td><a href="mailto:askastudent@simons-rock.edu" style="text-decoration: none">
							<button type="submit" name="button3" value="clicked" style="text-decoration: none; width:162px; height: 57px; background: url(/admission/images/buttons.png); color: navy; font-family: Tahoma, Arial, Verdana, Geneva, sans-serif; font-size:13px; line-height: 19px; font-weight:bold; cursor:pointer; border: 1px outset buttonface">
							Email a student
							</button></a></td>
						<td><a href="http://www.facebook.com/simonsrock" style="text-decoration: none">
							<button type="submit" name="button4" value="clicked" style="text-decoration: none; width:162px; height: 57px; background: url(/admission/images/buttons.png); color: navy; font-family: Tahoma, Arial, Verdana, Geneva, sans-serif; font-size:13px; line-height: 19px; font-weight:bold; cursor:pointer;; border: 1px outset buttonface">
...
<!--				<p>Want to talk to one of our students who left high school after 10th or 11th grade? Visit our <a href="http://www.facebook.com/simonsrock">facebook page</a> or <a href="mailto:askastudent@simons-rock.edu">send a message</a>. Our current students also call prospective students many Wednesday and Thursday evenings. If you'd like to receive a call then, click <span id="Wednesday" class="action" onClick="requestCall('Wednesday')">Wednesday</span> or <span id="Thursday" class="action" onClick="requestCall('Thursday')">Thursday</span> to let us know which is better for you (you don't need to fill out another form).</p> -->
				...
				<div style="height: auto">
					<div id="questionDiv">
						...
						<img src="/admission/images/<?php echo($pic);?>" style="float:left; margin: 0 5px">
						...
						<button id="askCounselor" onClick="askQuestion()" value="Ask!" disabled="disabled" style="border:1px solid #999; padding:6px 10px; font-size: 15px; float:right; cursor:default; ">Ask!</button>
					</div>

...
$academicInterests = explode(",",unserialize($_REQUEST['acint']));
$extracurricularInterests = explode(",",unserialize($_REQUEST['exint']));
...
<body style="margin:0">
<div style="width: 700px; height: 175px;">
<?php 
if(count($academicInterests)) {
	echo "<p>Your academic interests";
	foreach($academicInterests as $academicInterest){
		echo $academicInterest . " ";
	}
	echo "</p>";
	$interests++;
}
if(count($extracurricularInterests)) {
	echo "<p>Your extracurricular interests: ";
	foreach($extracurricularInterests as $extracurricularInterest){
		echo $extracurricularInterest . " ";
	}
	echo "</p>";
	$interests++;
}
if(!$interests){
	echo "<p>No interests specified.</p>";
}
?>
</div>

			...
			<div style="float:right; width:560px;">
				...
				<table width="450" align="center" cellpadding="0" cellspacing="3" >
					<tr>
						...
						<td>
							<button onClick="requestCall('Thursday')" type="submit" name="Thursday" id="Thursday" value="clicked" style="width:162px; height: 57px; background: url(images/buttons.png); color: navy; font-family: Tahoma, Arial, Verdana, Geneva, sans-serif; font-size:13px; line-height: 19px; font-weight:bold; cursor:pointer; border: 1px outset buttonface">

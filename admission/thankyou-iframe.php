...
elseif($couns == "cdekoven"){
	$pic = "leslie-globe.gif";
	$couns_name = "Chandra Joos";
	$couns_fname = "Chandra";
	$couns_pron = "her";
}
...
<?php
		...
		if(isset($_REQUEST['showPDF'])){
			echo '<p><a href="http://forms.simons-rock.edu/admission/l/5-signs-ready-for-college/check_list.pdf" target="_blank">View the Checklist</p>';
		}
...
<?php
    // added this to remove the video for some pages that include this file
    if(isset($_REQUEST['hideVideo'])){
        $hideVideo = $_REQUEST['hideVideo'];
    }
    $width = "700";
    $float = "right";
    $height = "25";
...
?>
			...
			<div style="float:<?php echo $float;?>; width:<?php echo $width;?>px;">
...
-->
				...
				<div style="width: <?php echo $width;?>px; height: 200px">
	...
	<form id="question" name="question" action="/admission/askquestion.php" method="post">
	    ...
	    <input type="submit" name="submit" value="Ask!" style="border:1px solid #999; padding:6px 10px; font-size: 15px; cursor:pointer; ">
    </form>

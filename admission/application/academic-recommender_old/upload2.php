...
-->
			...
			<div id="IWDF-dialog-14" title="Please select your file" style="display:none;">
				<form enctype="multipart/form-data" target="IWDF-frame-15" method="post">
					...
					<p></p>
					<input style="width:100%;" name="description" type="hidden" value="Academic Recommendation and Evaluation 1, upload 2" />
					...
					<input name="inquiryFormId" value="685000008428182" type="hidden" />
					<input name="domainObjectId" value="685000008428182" type="hidden" />
				</form>
			</div>
			<script type="text/javascript">
// <![CDATA[

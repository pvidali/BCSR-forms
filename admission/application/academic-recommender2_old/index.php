...
</div>		<div id="form-wrapper" class="ui-tabs-left">
											...
											<ul class="control-child-helper control-draggable clearfix wide">
												...
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-29" class="form-control field-control">
														<label class="dynamic-form-required top">* Last Name</label>
														<input id="Connections.Teacher to Student.records.IWDF-row-40.685000000003017" maxlength="80" name="Connections.Teacher to Student.records.IWDF-row-40.685000000003017" value="<?php echo ($stdt_lname);?>" type="text" />
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Connections.Teacher to Student.records.IWDF-row-40.685000000003017", "notEmpty", null, { trim: true, isReqFunc: true, disabled: true });
// ]]>
</script>
													</div>
												</li>
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-31" class="form-control field-control">
														...
														<input id="Connections.Teacher to Student.records.IWDF-row-40.685000000003021" maxlength="100" name="Connections.Teacher to Student.records.IWDF-row-40.685000000003021" value="<?php echo ($stdt_eml);?>" type="text" />
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Connections.Teacher to Student.records.IWDF-row-40.685000000003021", "validEmail", null, { trim: true, emptyvalid: true });
// ]]>
</script>
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Connections.Teacher to Student.records.IWDF-row-40.685000000003021", "notEmpty", null, { trim: true, isReqFunc: true, disabled: true });
// ]]>
</script>
													</div>
												</li>
												...
												<li class="control-child-wrapper">
													<div id="IWDF-control-32" class="form-control hidden field-control">
														...
														<select id="Connections.Teacher to Student.records.IWDF-row-40.685000000029363" name="Connections.Teacher to Student.records.IWDF-row-40.685000000029363" disabled="disabled">
															<option value=""></option>
...
// ]]>
				...
				<fieldset>
                    ...
                    <div style="width:880px; height:300px">
                    	<div class="ifbox">
							...
							<iframe name="uploadFrame" id="uploadFrame" src="upload.php?stdt_lname=<?php echo($stdt_lname); ?>&stdt_eml=<?php echo($stdt_eml); ?>" frameborder="0" height="250" scrolling="no" width="430" style="float:left"></iframe>
                        </div>
                    	<div class="ifbox">
				...
				<div class="form-action-bar bottom">
					...
					<div class="middle-buttons">
						<button style="padding: 10px; font-size: 1.5em; font-weight: bold; border: 2px solid;" class="submit fg-button ui-state-default ui-corner-all"
                         onclick="disp_confirm(this.form);" type="button">Submit</button>
					</div>
				</div>
			</form>

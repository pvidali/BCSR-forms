						...
						<ul class="page-child-helper">
							<li class="page-child-wrapper">
								<div id="IWDF-control-12" sectiontitle="Contact Attachments" class="form-control section-control page-child">
									<p style="padding-left: 10px"><strong>Secondary School Recommendation and Evaluation (required)</strong></p>
...
-->
			...
			<div id="IWDF-dialog-14" title="Please select your file" style="display:none;">
				<form enctype="multipart/form-data" target="IWDF-frame-15" method="post">
					<br />
					<div>
						<input id="IWDF-upload-16" maxlength="100" style="padding-left:5px;color:rgb(0, 0, 0);background-color:rgb(255, 255, 255);display:inline;border:1px solid rgb(186, 186, 186);" name="ContactAttachment" value="" type="file" onchange="_IW.FormsRuntime.checkFileType(this);" />
						<span id="IWDF-spinner-17" style="display:none;" class="spinner"></span>
					</div>
					<p></p>
					<input style="width:100%;" name="description" type="hidden" value="Secondary School Recommendation and Evaluation, upload 1" />
					<div style="text-align:right;">
						<button onclick="return _IW.FormsRuntime.initiateUpload(&quot;IWDF-frame-15&quot;, &quot;IWDF-upload-16&quot;, &quot;IWDF-dialog-14&quot;, &quot;IWDF-spinner-17&quot;, function(filesUploaded) { _IW.FormsRuntime.processUpload(filesUploaded, &quot;IWDF-button-13&quot;, true);});" class="fg-button ui-state-default ui-corner-all" type="button">Click to Attach File</button>
					</div>
					<input name="inquiryFormId" value="685000007346083" type="hidden" />
					<input name="domainObjectId" value="685000007346083" type="hidden" />
				</form>
			</div>
			<script type="text/javascript">
// <![CDATA[

...
<!--             <input type="checkbox" name="both_parents" id="both_parents"  onClick="toggleSubmitValue(this.checked)" />  -->
    ...
    <div id="both_msg" style="display:none">
        <strong>IMPORTANT: </strong>Please complete and submit information for yourself first, using this form. After that has been submitted, this page will reload so you may input information for the other parent.
    </div>

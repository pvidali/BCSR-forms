...
function disp_confirm(theForm) {
	...
	if (document.layers||document.getElementById||document.all) {
        if (document.getElementById('Contacts.685000000003017').value.length == 0) {
            document.getElementById('Contacts.685000000003017').style.backgroundColor = highlight
            rval = false
			if(fieldFocus == ""){
				fieldFocus = "Contacts.685000000003017";
			}
		} 
		else {
            document.getElementById('Contacts.685000000003017').style.backgroundColor = normal
		}
        if (document.getElementById('Contacts.685000000003015').value.length == 0) {
            document.getElementById('Contacts.685000000003015').style.backgroundColor = highlight
            rval = false
			if(fieldFocus == ""){
				fieldFocus = "Contacts.685000000003015";
			}
		} 
		else {
            document.getElementById('Contacts.685000000003015').style.backgroundColor = normal
		}
        if (document.getElementById('Contacts.685000000003051').value.length == 0) {
            document.getElementById('Contacts.685000000003051').style.backgroundColor = highlight
            rval = false
			if(fieldFocus == ""){
				fieldFocus = "Contacts.685000000003051";
			}
		} 
		else {
            document.getElementById('Contacts.685000000003051').style.backgroundColor = normal
		}		
        if (document.getElementById('Contacts.685000000003021').value.length == 0) {
            document.getElementById('Contacts.685000000003021').style.backgroundColor = highlight
            rval = false
			if(fieldFocus == ""){
				fieldFocus = "Contacts.685000000003021";
			}
		} 
		else {
            document.getElementById('Contacts.685000000003021').style.backgroundColor = normal
		}
        if (document.getElementById('Contacts.685000000003063').value.length == 0) {
            document.getElementById('Contacts.685000000003063').style.backgroundColor = highlight
            rval = false
			if(fieldFocus == ""){
				fieldFocus = "Contacts.685000000003063";
			}
		} 
		else {
            document.getElementById('Contacts.685000000003063').style.backgroundColor = normal
		}
        if (document.getElementById('Contacts.685000000003065').value.length == 0) {
            document.getElementById('Contacts.685000000003065').style.backgroundColor = highlight
            rval = false
			if(fieldFocus == ""){
				fieldFocus = "Contacts.685000000003065";
			}
		} 
		else {
            document.getElementById('Contacts.685000000003065').style.backgroundColor = normal
		}

		if(document.getElementById('Contacts.685000000003027').value == "" && 
		   document.getElementById('Contacts.685000000003031').value == "" &&
		   document.getElementById('Contacts.685000007210339').value == "") {
			
			document.getElementById('Contacts.685000000003027').style.backgroundColor = highlight
		    document.getElementById('Contacts.685000000003031').style.backgroundColor = highlight
		    document.getElementById('Contacts.685000007210339').style.backgroundColor = highlight
			
			alert("At least one phone number is required");
			document.getElementById('Contacts.685000000003027').focus();
			return false;
		}
		else{
			document.getElementById('Contacts.685000000003027').style.backgroundColor = normal
		    document.getElementById('Contacts.685000000003031').style.backgroundColor = normal
		    document.getElementById('Contacts.685000007210339').style.backgroundColor = normal
		}
        if (document.getElementById('Contacts.685000007145923').value.length == 0) {
            document.getElementById('Contacts.685000007145923').style.backgroundColor = highlight
            rval = false
			if(fieldFocus == ""){
				fieldFocus = "Contacts.685000007145923";
			}
		} 
		else {
            document.getElementById('Contacts.685000007145923').style.backgroundColor = normal
		}

		if(document.getElementById('Contacts.685000000131001').value == "" && document.getElementById('Contacts.685000007145923').value != "United States") {
			if(document.getElementById('Contacts.685000007210389').value == ""){
				alert("Please specify how many years you have resided in the United States.");
				document.getElementById('Contacts.685000007210389').focus();
				return false;
			}
		}
		...
		else if(!checkUploadStatus()){
			var r=confirm("You haven't uploaded a narrative statement. Are you sure you want to submit the form without uploading a narrative?\n\nClick cancel if you would like to upload a narrative statement, or 'OK' if you don't.")
			if (r==true) {
...
// ]]>
		...
		<div id="form-wrapper" class="ui-tabs-left">
			...
			<form target="_dummy" action="javascript:void(0);">
				<div id="IWDF-dynamicform-101" class="dynamicFormDefaults clearfix">
					<ul style="display:none">
						<li>
							<a href="#IWDF-page-102">Untitled Page</a>
						</li>
					</ul>
					<div id="IWDF-page-102">
						...
						<ul class="page-child-helper">
							...
							<li class="page-child-wrapper">
								<div id="IWDF-control-6" sectiontitle="Your information" class="form-control section-control page-child">
									<ul class="control-child-helper control-draggable clearfix wide">
										...
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-8" class="form-control field-control">
												<label class="dynamic-form-required left">* Last Name</label>
...
// ]]>
										...
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-10" class="form-control field-control">
												<label class="dynamic-form-required left">* First Name</label>
...
// ]]>
										...
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-12" class="form-control field-control">
												<label class="left">Middle Name</label>
												<input id="Contacts.685000000101061" maxlength="12" name="Contacts.685000000101061" value="" type="text" />
												<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Contacts.685000000101061", "notEmpty", null, { trim: true, isReqFunc: true, disabled: true });
// ]]>
</script>
											</div>
										</li>
										...
										<li class="control-draggable control-child-wrapper" style="display:none">
											<div id="IWDF-control-14" class="form-control field-control">
												<label class="top">Deceased</label>
												<input id="Contacts.685000007371697" name="Contacts.685000007371697" value="on" type="checkbox" />
											</div>
										</li>
										<li class="control-draggable control-child-wrapper" style="display:none">
											<div id="IWDF-control-16" class="form-control field-control">
												<label class="top">Date Deceased</label>
												<input id="Contacts.685000007145921" maxlength="100" name="Contacts.685000007145921" value="" type="text" />
												<br />
												<span style="color:rgb(0, 0, 0);">[mm/dd/yyyy]</span>
												<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Contacts.685000007145921", "validDate", "Please enter a valid date [mm/dd/yyyy]", { compareTo: "MM/dd/yyyy", trim: true, emptyvalid: true });
// ]]>
</script>
												<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Contacts.685000007145921", "notEmpty", null, { isReqFunc: true, disabled: true });
// ]]>
</script>
											</div>
										</li>
										...
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-20" class="form-control field-control">
												<label class="dynamic-form-required left">* Gender</label>
												<select id="Contacts.685000000003051" name="Contacts.685000000003051">
												...
												<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addSingleSelectValidator("Contacts.685000000003051", "Please select 1 item", { isReqFunc: true });
// ]]>
</script>
											</div>
										</li>
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-18" class="form-control field-control">
												<label class="dynamic-form-required left">* Email</label>
												<input id="Contacts.685000000003021" maxlength="100" name="Contacts.685000000003021" value="" type="text" onblur="echeck(this.value,this.id)" />
												<script type="text/javascript">
// <![CDATA[
...
// ]]>
												...
												<span class="note">(If you use spam filtering, please accept email from simons-rock.edu)</span>
											</div>
										</li>
										<li class="clear-float"></li>
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-22" class="form-control field-control">
												<label class="dynamic-form-required left">* Street Address</label>
												<input id="Contacts.685000000003063" maxlength="250" name="Contacts.685000000003063" value="" type="text" />
												<script type="text/javascript">
// <![CDATA[
...
// ]]>
										...
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-24" class="form-control field-control">
												<label class="left">Street, Line 2</label>
												<input id="Contacts.685000000121961" maxlength="30" name="Contacts.685000000121961" value="" type="text" />
												<script type="text/javascript">
// <![CDATA[
...
// ]]>
										...
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-26" class="form-control field-control">
												<label class="dynamic-form-required left">* City</label>
												<input id="Contacts.685000000003065" maxlength="30" name="Contacts.685000000003065" value="" type="text" />
												<script type="text/javascript">
// <![CDATA[
...
// ]]>
										...
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-28" class="form-control field-control">
												<label class="left">State or Province</label>
												<select id="Contacts.685000000123120" name="Contacts.685000000123120">
													<option selected="selected" value=""></option>
												...
												<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addSingleSelectValidator("Contacts.685000000123120", "Please select 1 item", { isReqFunc: true, disabled: true });
// ]]>
</script>
												<script type="text/javascript">
// <![CDATA[
_IW.FieldDep.addDependency("Contacts.685000000123120", "Contacts.685000007074687", {"":[""],"VT":["","Addison","Bennington","Caledonia","Chittenden","Essex","Franklin","Grand Isle","Lamoille","Orange","Orleans","Rutland","Washington","Windham","Windsor"],"RI":["","Bristol","Kent","Newport","Providence","Washington"],"HI":["","Hawaii","Honolulu","Kauai","Maui"],"VI":[""],"MH":[""],"ME":["","Androscoggin","Aroostook","Cumberland","Franklin","Hancock","Kennebec","Knox","Lincoln","Oxford","Penobscot","Piscataquis","Sagadahoc","Somerset","Waldo","Washington","York"],"VA":["","Accomack","Albemarle","Alexandria City","Alleghany","Amelia","Amherst","Appomattox","Arlington","Augusta","Bath","Bedford","Bland","Botetourt","Bristol","Brunswick","Buchanan","Buckingham","Buena Vista City","Campbell","Caroline","Carroll","Charles City","Charlotte","Charlottesville City","Chesapeake City","Chesterfield","Clarke","Colonial Heights City","Covington City","Craig","Culpeper","Cumberland","Danville City","Dickenson","Dinwiddie","Essex","Fairfax","Fairfax City","Falls Church City","Fauquier","Floyd","Fluvanna","Franklin","Franklin City","Frederick","Fredericksburg City","Galax City","Giles","Gloucester","Goochland","Grayson","Greene","Greensville","Halifax","Hampton City","Hanover","Harrisonburg City","Henrico","Henry","Highland","Hopewell City","Isle of Wight","James City","King George","King William","King and Queen","Lancaster","Lee","Lexington City","Loudoun","Louisa","Lunenburg","Lynchburg City","Madison","Manassas City","Manassas Park City","Martinsville City","Mathews","Mecklenburg","Middlesex","Montgomery","Nelson","New Kent","Newport News City","Norfolk City","Northampton","Northumberland","Norton City","Nottoway","Orange","Page","Patrick","Petersburg City","Pittsylvania","Poquoson City","Portsmouth City","Powhatan","Prince Edward","Prince George","Prince William","Pulaski","Radford","Rappahannock","Richmond","Richmond City","Roanoke","Roanoke City","Rockbridge","Rockingham","Russell","Salem","Scott","Shenandoah","Smyth","Southampton","Spotsylvania","Stafford","Staunton City","Suffolk City","Surry","Sussex","Tazewell","Virginia Beach City","Warren","Washington","Waynesboro City","Westmoreland","Williamsburg City","Winchester City","Wise","Wythe","York"],"MI":["","Alcona","Alger","Allegan","Alpena","Antrim","Arenac","Baraga","Barry","Bay","Benzie","Berrien","Branch","Calhoun","Cass","Charlevoix","Cheboygan","Chippewa","Clare","Clinton","Crawford","Delta","Dickinson","Eaton","Emmet","Genesee","Gladwin","Gogebic","Grand Traverse","Gratiot","Hillsdale","Houghton","Huron","Ingham","Ionia","Iosco","Iron","Isabella","Jackson","Kalamazoo","Kalkaska","Kent","Keweenaw","Lake","Lapeer","Leelanau","Lenawee","Livingston","Luce","Mackinac","Macomb","Manistee","Marquette","Mason","Mecosta","Menominee","Midland","Missaukee","Monroe","Montcalm","Montmorency","Muskegon","Newaygo","Oakland","Oceana","Ogemaw","Ontonagon","Osceola","Oscoda","Otsego","Ottawa","PresqueIsle","Roscommon","Saginaw","Saint Clair","Saint Joseph","Sanilac","Schoolcraft","Shiawassee","Tuscola","Van Buren","Washtenaw","Wayne","Wexford"],"DE":["","Kent","New Castle","Sussex"],"ID":["","Ada","Adams","Bannock","Bear Lake","Benewah","Bingham","Blaine","Boise","Bonner","Bonneville","Boundary","Butte","Camas","Canyon","Caribou","Cassia","Clearwater","Custer","Elmore","Franklin","Fremont","Gem","Gooding","Idaho","Jefferson","Jerome","Kootenai","Latah","Lemhi","Lewis","Lincoln","Madison","Minidoka","Nez Perce","Oneida","Owyhee","Payette","Power","Shoshone","Teton","Twin Falls","Valley","Washington"],"IA":["","Adair","Adams","Allamakee","Appanoose","Audubon","Benton","Black Hawk","Boone","Bremer","Buchanan","Buena Vista","Butler","Calhoun","Carroll","Cass","Cedar","Cerro Gordo","Cherokee","Chickasaw","Clarke","Clay","Clayton","Clinton","Crawford","Dallas","Davis","Decatur","Delaware","Des Moines","Dickinson","Dubuque","Emmet","Fayette","Floyd","Franklin","Fremont","Greene","Grundy","Guthrie","Hamilton","Hancock","Hardin","Harrison","Henry","Howard","Humboldt","Ida","Iowa","Jackson","Jasper","Jefferson","Johnson","Jones","Keokuk","Kossuth","Lee","Linn","Louisa","Lucas","Lyon","Madison","Mahaska","Marion","Marshall","Mills","Mitchell","Monona","Monroe","Montgomery","Muscatine","Obrien","Osceola","Page","Palo Alto","Plymouth","Pocahontas","Polk","Pottawattamie","Poweshiek","Ringgold","Sac","Scott","Shelby","Sioux","Story","Tama","Taylor","Union","Van Buren","Wapello","Warren","Washington","Wayne","Webster","Winnebago","Winneshiek","Woodbury","Worth","Wright"],"MD":["","Allegany","Anne Arundel","Baltimore","Baltimore City","Calvert","Caroline","Carroll","Cecil","Charles","Dorchester","Frederick","Garrett","Harford","Howard","Kent","Montgomery","Prince Georges","Queen Annes","Saint Marys","Somerset","Washington","Wicomico","Worcester"],"MA":["","Barnstable","Berkshire","Bristol","Dukes","Essex","Franklin","Hampden","Hampshire","Middlesex","Nantucket","Norfolk","Plymouth","Suffolk","Worcester"],"MB":[""],"AS":[""],"AR":["","Arkansas","Ashley","Baxter","Benton","Boone","Bradley","Calhoun","Carroll","Chicot","Clark","Clay","Cleburne","Cleveland","Columbia","Conway","Craighead","Crawford","Crittenden","Cross","Dallas","Desha","Drew","Faulkner","Franklin","Fulton","Garland","Grant","Greene","Hempstead","Hot Spring","Howard","Independence","Izard","Jackson","Jefferson","Johnson","Lafayette","Lawrence","Lee","Lincoln","Little River","Logan","Lonoke","Madison","Marion","Miller","Mississippi","Monroe","Montgomery","Nevada","Newton","Ouachita","Perry","Phillips","Pike","Poinsett","Polk","Pope","Prairie","Pulaski","Randolph","Saint Francis","Saline","Scott","Searcy","Sebastian","Sevier","Sharp","Stone","Union","Van Buren","Washington","White","Woodruff","Yell"],"UT":["","Beaver","Box Elder","Cache","Carbon","Daggett","Davis","Duchesne","Emery","Garfield","Grand","Iron","Juab","Kane","Millard","Morgan","Piute","Rich","Salt Lake","San Juan","Sanpete","Sevier","Summit","Tooele","Uintah","Utah","Wasatch","Washington","Wayne","Weber"],"IL":["","Adams","Alexander","Bond","Boone","Brown","Bureau","Calhoun","Carroll","Cass","Champaign","Christian","Clark","Clay","Clinton","Coles","Cook","Crawford","Cumberland","De Kalb","Dewitt","Douglas","Dupage","Edgar","Edwards","Effingham","Fayette","Ford","Franklin","Fulton","Gallatin","Greene","Grundy","Hamilton","Hancock","Hardin","Henderson","Henry","Iroquois","Jackson","Jasper","Jefferson","Jersey","Jo Daviess","Johnson","Kane","Kankakee","Kendall","Knox","La Salle","Lake","Lawrence","Lee","Livingston","Logan","Macon","Macoupin","Madison","Marion","Marshall","Mason","Massac","McDonough","McHenry","McLean","Menard","Mercer","Monroe","Montgomery","Morgan","Moultrie","Ogle","Peoria","Perry","Piatt","Pike","Pope","Pulaski","Putnam","Randolph","Richland","Rock Island","Saint Clair","Saline","Sangamon","Schuyler","Scott","Shelby","Stark","Stephenson","Tazewell","Union","Vermilion","Wabash","Warren","Washington","Wayne","White","Whiteside","Will","Williamson","Winnebago","Woodford"],"IN":["","Adams","Allen","Bartholomew","Benton","Blackford","Boone","Brown","Carroll","Cass","Clark","Clay","Clinton","Crawford","Daviess","De Kalb","Dearborn","Decatur","Delaware","Dubois","Elkhart","Fayette","Floyd","Fountain","Franklin","Fulton","Gibson","Grant","Greene","Hamilton","Hancock","Harrison","Hendricks","Henry","Howard","Huntington","Jackson","Jasper","Jay","Jefferson","Jennings","Knox","Kosciusko","La Porte","Lagrange","Lake","Lawrence","Madison","Marion","Marshall","Martin","Miami","Monroe","Montgomery","Newton","Noble","Ohio","Orange","Owen","Parke","Perry","Pike","Porter","Posey","Pulaski","Putnam","Randolph","Ripley","Rush","Scott","Shelby","Spencer","St Joseph","Starke","Steuben","Sullivan","Switzerland","Tippecanoe","Tipton","Union","Vanderburgh","Vermillion","Vigo","Wabash","Warren","Warrick","Washington","Wayne","Wells","White","Whitley"],"QC":[""],"MN":["","Aitkin","Anoka","Becker","Beltrami","Benton","Big Stone","Blue Earth","Brown","Carlton","Carver","Cass","Chippewa","Chisago","Clay","Clearwater","Cook","Cottonwood","Crow Wing","Dakota","Dodge","Douglas","Faribault","Fillmore","Freeborn","Goodhue","Grant","Hennepin","Houston","Hubbard","Isanti","Itasca","Jackson","Kanabec","Kandiyohi","Kittson","Koochiching","Lac Qui Parle","Lake","Lake of the Woods","Le Sueur","Lincoln","Lyon","Mahnomen","Marshall","Martin","McLeod","Meeker","Mille Lacs","Morrison","Mower","Murray","Nicollet","Nobles","Norman","Olmsted","Otter Tail","Pennington","Pine","Pipestone","Polk","Pope","Ramsey","Red Lake","Redwood","Renville","Rice","Rock","Roseau","Saint Louis","Scott","Sherburne","Sibley","Stearns","Steele","Stephens","Swift","Todd","Traverse","Wabasha","Wadena","Waseca","Washington","Watonwan","Wilkin","Winona","Wright","Yellow Medicine"],"AZ":["","Apache","Cochise","Coconino","Gila","Graham","Greenlee","La Paz","Maricopa","Mohave","Navajo","Pima","Pinal","Santa Cruz","Yavapai","Yuma"],"MO":["","Adair","Andrew","Atchison","Audrain","Barry","Barton","Bates","Benton","Bollinger","Boone","Buchanan","Butler","Caldwell","Callaway","Camden","Cape Girardeau","Carroll","Carter","Cass","Cedar","Chariton","Christian","Clark","Clay","Clinton","Cole","Cooper","Crawford","Dade","Dallas","Daviess","De Kalb","Dent","Douglas","Dunklin","Franklin","Gasconade","Gentry","Greene","Grundy","Harrison","Henry","Hickory","Holt","Howard","Howell","Iron","Jackson","Jasper","Jefferson","Johnson","Knox","Laclede","Lafayette","Lawrence","Lewis","Lincoln","Linn","Livingston","Macon","Madison","Maries","Marion","McDonald","Mercer","Miller","Mississippi","Moniteau","Monroe","Montgomery","Morgan","New Madrid","Newton","Nodaway","Oregon","Osage","Ozark","Pemiscot","Perry","Pettis","Phelps","Pike","Platte","Polk","Pulaski","Putnam","Ralls","Randolph","Ray","Reynolds","Ripley","Saint Charles","Saint Clair","Saint Francois","Saint Louis","Saint Louis City","Sainte Genevieve","Saline","Schuyler","Scotland","Scott","Shannon","Shelby","Stoddard","Stone","Sullivan","Taney","Texas","Vernon","Warren","Washington","Wayne","Webster","Worth","Wright"],"MT":["","Beaverhead","Big Horn","Blaine","Broadwater","Carbon","Carter","Cascade","Chouteau","Custer","Daniels","Dawson","Deer Lodge","Fallon","Fergus","Flathead","Gallatin","Garfield","Glacier","Golden Valley","Granite","Hill","Jefferson","Judith Basin","Lake","Lewis and Clark","Liberty","Lincoln","Madison","McCone","Meagher","Mineral","Missoula","Musselshell","Park","Petroleum","Phillips","Pondera","Powder River","Powell","Prairie","Ravalli","Richland","Roosevelt","Rosebud","Sanders","Sheridan","Silver Bow","Stillwater","Sweet Grass","Teton","Toole","Treasure","Valley","Wheatland","Wibaux","Yellowstone"],"MS":["","Adams","Alcorn","Amite","Attala","Benton","Bolivar","Calhoun","Carroll","Chickasaw","Choctaw","Claiborne","Clarke","Clay","Coahoma","Copiah","Covington","DeSoto","Forrest","Franklin","George","Greene","Grenada","Hancock","Harrison","Hinds","Holmes","Humphreys","Issaquena","Itawamba","Jackson","Jasper","Jefferson","Jefferson Davis","Jones","Kemper","Lafayette","Lamar","Lauderdale","Lawrence","Le Flore","Leake","Lee","Lincoln","Lowndes","Madison","Marion","Marshall","Monroe","Montgomery","Neshoba","Newton","Noxubee","Oktibbeha","Panola","Pearl River","Perry","Pike","Pontotoc","Prentiss","Quitman","Rankin","Scott","Sharkey","Simpson","Smith","Stone","Sunflower","Tallahatchie","Tate","Tippah","Tishomingo","Tunica","Union","Walthall","Warren","Washington","Wayne","Webster","Wilkinson","Winston","Yalobusha","Yazoo"],"NF":[""],"NH":["","Belknap","Carroll","Cheshire","Coos","Grafton","Hillsborough","Merrimack","Rockingham","Strafford","Sullivan"],"AA":[""],"AB":[""],"NJ":["","Atlantic","Bergen","Burlington","Camden","Cape May","Cumberland","Essex","Gloucester","Hudson","Hunterdon","Mercer","Middlesex","Monmouth","Morris","Ocean","Passaic","Salem","Somerset","Sussex","Union","Warren"],"PQ":[""],"PR":[""],"AE":[""],"NM":["","Bernalillo","Catron","Chaves","Cibola","Colfax","Curry","De Baca","Dona Ana","Eddy","Grant","Guadalupe","Harding","Hidalgo","Lea","Lincoln","Los Alamos","Luna","McKinley","Mora","Otero","Quay","Rio Arriba","Roosevelt","San Juan","San Miguel","Sandoval","Santa Fe","Sierra","Socorro","Taos","Torrance","Union","Valencia"],"AK":["","Aleutians East","Aleutians West","Anchorage","Bethel","Bristol Bay","Denali","Dillingham","Fairbanks North Star","Haines","Juneau","Kenai Peninsula","Ketchikan Gateway","Kodiak Island","Lake And Peninsula","Matanuska Susitna","Nome","North Slope","Northwest Arctic","Prince Wales Ketchikan","Sitka","Skagway Hoonah Angoon","Southeast Fairbanks","Valdez Cordova","Wade Hampton","Wrangell Petersburg","Yakutat","Yukon Koyukuk"],"AL":["","Autauga","Baldwin","Barbour","Bibb","Blount","Bullock","Butler","Calhoun","Chambers","Cherokee","Chilton","Choctaw","Clark","Clay","Cleburne","Coffee","Colbert","Conecuh","Coosa","Covington","Crenshaw","Cullman","Dale","Dallas","De Kalb","Elmore","Escambia","Etowah","Fayette","Franklin","Geneva","Greene","Hale","Henry","Houston","Jackson","Jefferson","Juneau","Lamar","Lauderdale","Lawrence","Lee","Limestone","Lowndes","Macon","Madison","Marengo","Marion","Marshall","Mobile","Monroe","Montgomery","Morgan","Perry","Pickens","Pike","Randolph","Russell","Saint Clair","Shelby","Sumter","Talladega","Tallapoosa","Tuscaloosa","Walker","Washington","Wilcox","Winston"],"TX":["","Anderson","Andrews","Angelina","Aransas","Archer","Armstrong","Atascosa","Austin","Bailey","Bandera","Bastrop","Baylor","Bee","Bell","Bexar","Blanco","Borden","Bosque","Bowie","Brazoria","Brazos","Brewster","Briscoe","Brooks","Brown","Burleson","Burnet","Caldwell","Calhoun","Callahan","Cameron","Camp","Carson","Cass","Castro","Chambers","Cherokee","Childress","Clay","Cochran","Coke","Coleman","Collin","Collingsworth","Colorado","Comal","Comanche","Concho","Cooke","Coryell","Cottle","Crane","Crockett","Crosby","Culberson","Dallam","Dallas","Dawson","Deaf Smith","Delta","Denton","Dewitt","Dickens","Dimmit","Donley","Duval","Eastland","Ector","Edwards","El Paso","Ellis","Erath","Falls","Fannin","Fayette","Fisher","Floyd","Foard","Fort Bend","Franklin","Freestone","Frio","Gaines","Galveston","Garza","Gillespie","Glasscock","Goliad","Gonzales","Gray","Grayson","Gregg","Grimes","Guadalupe","Hale","Hall","Hamilton","Hansford","Hardeman","Hardin","Harris","Harrison","Hartley","Haskell","Hays","Hemphill","Henderson","Hidalgo","Hill","Hockley","Hood","Hopkins","Houston","Howard","Hudspeth","Hunt","Hutchinson","Irion","Jack","Jackson","Jasper","Jeff Davis","Jefferson","Jim Hogg","Jim Wells","Johnson","Jones","Karnes","Kaufman","Kendall","Kenedy","Kent","Kerr","Kimble","King","Kinney","Kleberg","Knox","La Salle","Lamar","Lamb","Lampasas","Lavaca","Lee","Leon","Liberty","Limestone","Lipscomb","Live Oak","Llano","Loving","Lubbock","Lynn","Madison","Marion","Martin","Mason","Matagorda","Maverick","McCulloch","McLennan","McMullen","Medina","Menard","Midland","Milam","Mills","Mitchell","Montague","Montgomery","Moore","Morris","Motley","Nacogdoches","Navarro","Newton","Nolan","Nueces","Ochiltree","Oldham","Orange","Palo Pinto","Panola","Parker","Parmer","Pecos","Polk","Potter","Presidio","Rains","Randall","Reagan","Real","Red River","Reeves","Refugio","Roberts","Robertson","Rockwall","Runnels","Rusk","Sabine","San Augustine","San Jacinto","San Patricio","San Saba","Schleicher","Scurry","Shackelford","Shelby","Sherman","Smith","Somervell","Starr","Stephens","Sterling","Stonewall","Sutton","Swisher","Tarrant","Taylor","Terrell","Terry","Throckmorton","Titus","Tom Green","Travis","Trinity","Tyler","Upshur","Upton","Uvalde","Val Verde","Van Zandt","Victoria","Walker","Waller","Ward","Washington","Webb","Wharton","Wheeler","Wichita","Wilbarger","Willacy","Williamson","Wilson","Winkler","Wise","Wood","Yoakum","Young","Zapata","Zavala"],"YT":[""],"NB":[""],"AP":[""],"NC":["","Alamance","Alexander","Alleghany","Anson","Ashe","Avery","Beaufort","Bertie","Bladen","Brunswick","Buncombe","Burke","Cabarrus","Caldwell","Camden","Carteret","Caswell","Catawba","Chatham","Cherokee","Chowan","Clay","Cleveland","Columbus","Craven","Cumberland","Currituck","Dare","Davidson","Davie","Duplin","Durham","Edgecombe","Forsyth","Franklin","Gaston","Gates","Graham","Granville","Greene","Guilford","Halifax","Harnett","Haywood","Henderson","Hertford","Hoke","Hyde","Iredell","Jackson","Jones","Lee","Lenoir","Lincoln","Macon","Madison","Martin","McDowell","Mecklenburg","Mitchell","Montgomery","Moore","Nash","New Hanover","Northampton","Onslow","Orange","Pamlico","Pasquotank","Pender","Perquimans","Person","Pitt","Polk","Randolph","Richmond","Robeson","Rockingham","Rowan","Rutherford","Sampson","Scotland","Stanly","Stokes","Surry","Swain","Transylvania","Tyrrell","Union","Vance","Wake","Warren","Washington","Watauga","Wayne","Wilkes","Wilson","Yadkin","Yancey"],"ND":["","Adams","Barnes","Benson","Billings","Bottineau","Bowman","Burke","Burleigh","Cass","Cavalier","Dickey","Divide","Dunn","Eddy","Emmons","Foster","Golden Valley","Grand Forks","Grant","Griggs","Hettinger","Kidder","Lamoure","Logan","McHenry","McKenzie","McLean","Mercer","Morton","Mountrail","Nelson","Oliver","Pembina","Pierce","Ramsey","Ransom","Renville","Richland","Rolette","Sargent","Sheridan","Sioux","Slope","Stark","Steele","Stutsman","Towner","Traill","Walsh","Ward","Wells","Williams"],"NE":["","Adams","Antelope","Arthur","Banner","Blaine","Boone","Box Butte","Boyd","Brown","Buffalo","Burt","Butler","Cass","Cedar","Chase","Cherry","Cheyenne","Clay","Colfax","Cuming","Custer","Dakota","Dawes","Dawson","Deuel","Dixon","Dodge","Douglas","Dundy","Fillmore","Franklin","Frontier","Furnas","Gage","Garden","Garfield","Gosper","Grant","Greeley","Hall","Hamilton","Harlan","Hayes","Hitchcock","Holt","Hooker","Howard","Jefferson","Johnson","Kearney","Keith","Keya Paha","Kimball","Knox","Lancaster","Lincoln","Logan","Loup","Madison","McPherson","Merrick","Morrill","Nance","Nemaha","Nuckolls","Otoe","Pawnee","Perkins","Phelps","Pierce","Platte","Polk","Red Willow","Richardson","Rock","Saline","Sarpy","Saunders","Scotts Bluff","Seward","Sheridan","Sherman","Sioux","Stanton","Thayer","Thomas","Thurston","Valley","Washington","Wayne","Webster","Wheeler","York"],"NY":["","Albany","Allegany","Bronx","Broome","Cattaraugus","Cayuga","Chautauqua","Chemung","Chenango","Clinton","Columbia","Cortland","Delaware","Dutchess","Erie","Essex","Franklin","Fulton","Genesee","Greene","Hamilton","Herkimer","Jefferson","Kings","Lewis","Livingston","Madison","Monroe","Montgomery","Nassau","New York","Niagara","Oneida","Onondaga","Ontario","Orange","Orleans","Oswego","Otsego","Putnam","Queens","Rensselaer","Richmond","Rockland","Saint Lawrence","Saratoga","Schenectady","Schoharie","Schuyler","Seneca","Steuben","Suffolk","Sullivan","Tioga","Tompkins","Ulster","Warren","Washington","Wayne","Westchester","Wyoming","Yates"],"GA":["","Appling","Atkinson","Bacon","Baker","Baldwin","Banks","Barrow","Bartow","Ben Hill","Berrien","Bibb","Bleckley","Brantley","Brooks","Bryan","Bulloch","Burke","Butts","Calhoun","Camden","Candler","Carroll","Catoosa","Charlton","Chatham","Chattahoochee","Chattooga","Cherokee","Clarke","Clay","Clayton","Clinch","Cobb","Coffee","Colquitt","Columbia","Cook","Coweta","Crisp","Dade","Dawson","De Kalb","Decatur","Dodge","Dooly","Dougherty","Douglas","Early","Echols","Effingham","Elbert","Emanuel","Evans","Fannin","Fayette","Floyd","Forsyth","Franklin","Fulton","Gilmer","Glascock","Glynn","Gordon","Grady","Greene","Gwinnett","Habersham","Hall","Hancock","Haralson","Harris","Hart","Heard","Henry","Houston","Irwin","Jackson","Jasper","Jeff Davis","Jefferson","Jenkins","Johnson","Jones","Lamar","Lanier","Laurens","Lee","Liberty","Lincoln","Long","Lowndes","Lumpkin","Macon","Madison","Marion","McDuffie","McIntosh","Meriwether","Miller","Mitchell","Monroe","Montgomery","Morgan","Murray","Muscogee","Newton","Oconee","Oglethorpe","Paulding","Peach","Pickens","Pierce","Pike","Polk","Pulaski","Putnam","Quitman","Rabun","Randolph","Richmond","Rockdale","Schley","Screven","Seminole","Spalding","Stephens","Stewart","Sumter","Talbot","Taliaferro","Tattnall","Taylor","Telfair","Thomas","Tift","Toombs","Towns","Treutlen","Troup","Turner","Twiggs","Union","Upson","Walker","Walton","Ware","Warren","Washington","Wayne","Webster","Wheeler","White","Whitfield","Wilcox","Wilkes","Wilkinson","Worth"],"NV":["","Carson City","Churchill","Clark","Douglas","Elko","Esmeralda","Eureka","Humboldt","Lander","Lincoln","Lyon","Mineral","Nye","Pershing","Storey","Washoe","White Pine"],"TN":["","Anderson","Bedford","Benton","Bledsoe","Blount","Bradley","Campbell","Cannon","Carroll","Carter","Cheatham","Chester","Claiborne","Clay","Cocke","Coffee","Crockett","Cumberland","Davidson","De Kalb","Decatur","Dickson","Dyer","Fayette","Fentress","Franklin","Gibson","Giles","Grainger","Greene","Grundy","Hamblen","Hamilton","Hancock","Hardeman","Hardin","Hawkins","Haywood","Henderson","Henry","Hickman","Houston","Humphreys","Jackson","Jefferson","Johnson","Knox","Lake","Lauderdale","Lewis","Lincoln","Loudon","Macon","Madison","Marion","Marshall","Maury","McMinn","McNairy","Meigs","Monroe","Montgomery","Moore","Morgan","Obion","Overton","Perry","Pickett","Polk","Putnam","Rhea","Roane","Robertson","Rutherford","Scott","Sequatchie","Sevier","Shelby","Smith","Stewart","Sullivan","Sumner","Tipton","Trousdale","Unicoi","Union","Van Buren","Washington","Wayne","Weakley","White","Williamson","Wilson"],"NT":[""],"NS":[""],"CA":["","Alameda","Alpine","Amador","Butte","Calaveras","Colusa","Contra Costa","Del Norte","El Dorado","Fresno","Glenn","Humboldt","Imperial","Inyo","Kern","Kings","Lake","Lassen","Los Angeles","Madera","Marin","Mariposa","Mendocino","Merced","Modoc","Mono","Monterey","Napa","Nevada","Orange","Placer","Plumas","Riverside","Sacramento","San Benito","San Bernardino","San Diego","San Francisco","San Joaquin","San Luis Obispo","San Mateo","Santa Barbara","Santa Clara","Santa Cruz","Shasta","Sierra","Siskiyou","Solano","Sonoma","Stanislaus","Sutter","Tehama","Trinity","Tulare","Tuolumne","Ventura","Yolo","Yuba"],"ON":[""],"OK":["","Adair","Alfalfa","Atoka","Beaver","Beckham","Blaine","Bryan","Caddo","Canadian","Carter","Cherokee","Choctaw","Cimarron","Cleveland","Coal","Comanche","Cotton","Craig","Creek","Custer","Delaware","Dewey","Ellis","Garfield","Garvin","Grady","Grant","Greer","Harmon","Harper","Haskell","Hughes","Jackson","Jefferson","Johnston","Kay","Kingfisher","Kiowa","Latimer","Le Flore","Lincoln","Logan","Love","Major","Marshall","Mayes","McClain","McCurtain","McIntosh","Murray","Muskogee","Noble","Nowata","Okfuskee","Oklahoma","Okmulgee","Osage","Ottawa","Pawnee","Payne","Pittsburg","Pontotoc","Pottawatomie","Pushmataha","Roger Mills","Rogers","Seminole","Sequoyah","Stephens","Texas","Tillman","Tulsa","Wagoner","Washington","Washita","Woods","Woodward"],"CNMI":[""],"BC":[""],"OH":["","Adams","Allen","Ashland","Ashtabula","Athens","Auglaize","Belmont","Brown","Butler","Carroll","Champaign","Clark","Clermont","Clinton","Columbiana","Coshocton","Crawford","Cuyahoga","Darke","Defiance","Delaware","Erie","Fairfield","Fayette","Franklin","Fulton","Gallia","Geauga","Greene","Guernsey","Hamilton","Hancock","Hardin","Harrison","Henry","Highland","Hocking","Holmes","Huron","Jackson","Jefferson","Knox","Lake","Lawrence","Licking","Logan","Lorain","Lucas","Madison","Mahoning","Marion","Medina","Meigs","Mercer","Miami","Monroe","Montgomery","Morgan","Morrow","Muskingum","Noble","Ottawa","Paulding","Perry","Pickaway","Pike","Portage","Preble","Putnam","Richland","Ross","Sandusky","Scioto","Seneca","Shelby","Stark","Summit","Trumbull","Tuscarawas","Union","Van Wert","Vinton","Warren","Washington","Wayne","Williams","Wood","Wyandot"],"WY":["","Albany","Big Horn","Campbell","Carbon","Converse","Crook","Fremont","Goshen","Hot Springs","Johnson","Laramie","Lincoln","Natrona","Niobrara","Park","Platte","Sheridan","Sublette","Sweetwater","Teton","Uinta","Washakie","Weston"],"FL":["","Alachua","Baker","Bay","Bradford","Brevard","Broward","Calhoun","Charlotte","Citrus","Clay","Collier","Columbia","De Soto","DeSoto","Dixie","Duval","Escambia","Flagler","Franklin","Gadsden","Gilchrist","Glades","Gulf","Hamilton","Hardee","Hendry","Hernando","Highlands","Hillsborough","Holmes","Indian River","Jackson","Jefferson","Lafayette","Lake","Lee","Leon","Levy","Liberty","Madison","Manatee","Marion","Martin","Miami-Dade","Monroe","Nassau","Okaloosa","Okeechobee","Orange","Osceola","Palm Beach","Pasco","Pinellas","Polk","Putnam","Saint Johns","Saint Lucie","Santa Rosa","Sarasota","Seminole","Sumter","Suwannee","Taylor","Union","Volusia","Wakulla","Walton","Washington"],"SD":["","Aurora","Beadle","Bennett","Bon Homme","Brookings","Brown","Brule","Buffalo","Butte","Campbell","Charles Mix","Clark","Clay","Codington","Corson","Custer","Davison","Day","Deuel","Dewey","Douglas","Edmunds","Fall River","Faulk","Grant","Gregory","Haakon","Hamlin","Hand","Hanson","Harding","Hughes","Hutchinson","Hyde","Jackson","Jerauld","Jones","Kingsbury","Lake","Lawrence","Lincoln","Lyman","Marshall","McCook","McPherson","Meade","Mellette","Miner","Minnehaha","Moody","Pennington","Perkins","Potter","Roberts","Sanborn","Shannon","Spink","Stanley","Sully","Todd","Tripp","Turner","Union","Walworth","Yankton","Ziebach"],"SC":["","Abbeville","Aiken","Allendale","Anderson","Bamberg","Barnwell","Beaufort","Berkeley","Calhoun","Charleston","Cherokee","Chester","Chesterfield","Clarendon","Colleton","Darlington","Dillon","Dorchester","Edgefield","Fairfield","Florence","Georgetown","Greenville","Greenwood","Hampton","Horry","Jasper","Kershaw","Lancaster","Laurens","Lee","Lexington","Marion","Marlboro","McCormick","Newberry","Oconee","Orangeburg","Pickens","Richland","Saluda","Spartanburg","Sumter","Union","Williamsburg","York"],"CT":["","Fairfield","Hartford","Litchfield","Middlesex","New Haven","New London","Tolland","Windham"],"WV":["","Barbour","Berkeley","Boone","Braxton","Brooke","Cabell","Calhoun","Clay","Doddridge","Fayette","Gilmer","Grant","Greenbrier","Hampshire","Hancock","Hardy","Harrison","Jackson","Jefferson","Kanawha","Lewis","Lincoln","Logan","Marion","Marshall","Mason","McDowell","Mercer","Mineral","Mingo","Monongalia","Monroe","Morgan","Nicholas","Ohio","Pendleton","Pleasants","Pocahontas","Preston","Putnam","Raleigh","Randolph","Ritchie","Roane","Summers","Taylor","Tucker","Tyler","Upshur","Wayne","Webster","Wetzel","Wirt","Wood","Wyoming"],"DC":[""],"SK":[""],"WI":["","Adams","Ashland","Barron","Bayfield","Brown","Buffalo","Burnett","Calumet","Chippewa","Clark","Columbia","Crawford","Dane","Dodge","Door","Douglas","Dunn","Eau Claire","Florence","Fond du Lac","Forest","Grant","Green","Green Lake","Iowa","Iron","Jackson","Jefferson","Juneau","Kenosha","Kewaunee","La Crosse","Lafayette","Langlade","Lincoln","Manitowoc","Marathon","Marinette","Marquette","Menominee","Milwaukee","Monroe","Oconto","Oneida","Outagamie","Ozaukee","Pepin","Pierce","Polk","Portage","Price","Racine","Richland","Rock","Rusk","Saint Croix","Sauk","Sawyer","Shawano","Sheboygan","Taylor","Trempealeau","Vernon","Vilas","Walworth","Washburn","Washington","Waukesha","Waupaca","Waushara","Winnebago","Wood"],"KY":["","Adair","Allen","Anderson","Ballard","Barren","Bath","Bell","Boone","Bourbon","Boyd","Boyle","Bracken","Breathitt","Breckinridge","Bullitt","Butler","Caldwell","Calloway","Campbell","Carlisle","Carroll","Carter","Casey","Christian","Clark","Clay","Clinton","Crittenden","Cumberland","Daviess","Edmonson","Elliott","Estill","Fayette","Fleming","Floyd","Franklin","Fulton","Gallatin","Garrard","Grant","Graves","Grayson","Green","Greenup","Hancock","Hardin","Harlan","Harrison","Hart","Henderson","Henry","Hickman","Hopkins","Jackson","Jefferson","Jessamine","Johnson","Kenton","Knott","Knox","Larue","Laurel","Lawrence","Lee","Leslie","Letcher","Lewis","Lincoln","Livingston","Logan","Lyon","Madison","Magoffin","Marion","Marshall","Martin","Mason","McCracken","McCreary","McLean","Meade","Menifee","Mercer","Metcalfe","Monroe","Montgomery","Morgan","Muhlenberg","Nelson","Nicholas","Ohio","Oldham","Owen","Owsley","Pendleton","Perry","Pike","Powell","Pulaski","Robertson","Rockcastle","Rowan","Russell","Scott","Shelby","Simpson","Spencer","Taylor","Todd","Trigg","Trimble","Union","Warren","Washington","Wayne","Webster","Whitley","Wolfe","Woodford"],"KS":["","Allen","Anderson","Atchison","Barber","Barton","Bourbon","Brown","Butler","Chase","Chautauqua","Cherokee","Cheyenne","Clark","Clay","Cloud","Coffey","Comanche","Cowley","Crawford","Decatur","Dickinson","Doniphan","Edwards","Elk","Ellis","Ellsworth","Finney","Ford","Franklin","Geary","Gove","Graham","Grant","Gray","Greeley","Greenwood","Hamilton","Harper","Harvey","Haskell","Hodgeman","Jackson","Jefferson","Jewell","Johnson","Kearny","Kingman","Kiowa","Labette","Lane","Leavenworth","Lincoln","Linn","Logan","Lyon","Marion","Marshall","McPherson","Meade","Miami","Mitchell","Montgomery","Morris","Morton","Nemaha","Neosho","Ness","Norton","Osage","Osborne","Ottawa","Pawnee","Phillips","Pottawatomie","Pratt","Rawlins","Reno","Republic","Rice","Riley","Rooks","Rush","Russell","Saline","Scott","Sedgwick","Seward","Shawnee","Sheridan","Sherman","Smith","Stafford","Stanton","Stevens","Sumner","Thomas","Trego","Wabaunsee","Wallace","Washington","Wichita","Wilson","Woodson","Wyandotte"],"OR":["","Baker","Benton","Clackamas","Clatsop","Columbia","Coos","Curry","Deschutes","Douglas","Gilliam","Grant","Harney","Hood River","Jackson","Jefferson","Josephine","Klamath","Lake","Lane","Lincoln","Linn","Malheur","Marion","Morrow","Multnomah","Polk","Sherman","Tillamook","Umatilla","Union","Wallowa","Wasco","Washington","Yamhill"],"LA":["","Acadia","Allen","Ascension","Assumption","Avoyelles","Beauregard","Bienville","Bossier","Caddo","Calcasieu","Caldwell","Cameron","Catahoula","Claiborne","Concordia","DeSoto","East Baton Rouge","East Carroll","East Feliciana","Evangeline","Franklin","Grant","Iberia","Iberville","Jackson","Jefferson","Jefferson Davis","La Salle","Lafayette","Lafourche","Lincoln","Livingston","Madison","Morehouse","Natchitoches","Orleans","Ouachita","Plaquemines","Pointe Coupee","Rapides","Red River","Richland","Sabine","St. Bernard","St. Charles","St. Helena","St. James","St. John the Baptist","St. Landry","St. Martin","St. Mary","St. Tammany","Tangipahoa","Tensas","Terrebonne","Union","Vermilion","Vernon","Washington","Webster","West Baton Rouge","West Carroll","West Feliciana","Winn"],"GU":[""],"WA":["","Adams","Asotin","Benton","Chelan","Clallam","Clark","Columbia","Cowlitz","Douglas","Ferry","Franklin","Garfield","Grant","Grays Harbor","Island","Jefferson","King","Kitsap","Kittitas","Klickitat","Lewis","Lincoln","Mason","Okanogan","Pacific","Pend Oreille","Pierce","San Juan","Skagit","Skamania","Snohomish","Spokane","Stevens","Thurston","Wahkiakum","Walla Walla","Whatcom","Whitman","Yakima"],"PE":[""],"CO":["","Adams","Alamosa","Arapahoe","Archuleta","Baca","Bent","Boulder","Broomfield","Chaffee","Cheyenne","Clear Creek","Conejos","Costilla","Crowley","Custer","Delta","Denver","Dolores","Douglas","Eagle","El Paso","Elbert","Fremont","Garfield","Gilpin","Grand","Gunnison","Hinsdale","Huerfano","Jackson","Jefferson","Kiowa","Kit Carson","La Plata","Lake","Larimer","Las Animas","Lincoln","Logan","Mesa","Mineral","Moffat","Montezuma","Montrose","Morgan","Otero","Ouray","Park","Phillips","Pitkin","Prowers","Pueblo","Rio Blanco","Rio Grande","Routt","Saguache","San Juan","San Miguel","Sedgwick","Summit","Teller","Washington","Weld","Yuma"],"PA":["","Adams","Allegheny","Armstrong","Beaver","Bedford","Berks","Blair","Bradford","Bucks","Butler","Cambria","Cameron","Carbon","Centre","Chester","Clarion","Clearfield","Clinton","Columbia","Crawford","Cumberland","Dauphin","Delaware","Elk","Erie","Fayette","Forest","Franklin","Fulton","Greene","Huntington","Indiana","Jefferson","Lancaster","Lawrence","Lebanon","Lehigh","Luzerne","Lycoming","McKean","Mercer","Mifflin","Monroe","Montgomery","Northampton","Northumberland","Perry","Philadelphia","Pike","Potter","Schuylkill","Snyder","Somerset","Sullivan","Susquehanna","Tioga","Union","Venango","Warren","Washington","Wayne","Westmoreland","Wyoming","York"]});
// ]]>
</script>
											</div>
										</li>
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-30" class="form-control field-control">
												<label class="left">County or Parish</label>
												<select id="Contacts.685000007074687" name="Contacts.685000007074687">
													<option selected="selected" value=""></option>
													...
													<option value="PresqueIsle">PresqueIsle</option>
												...
												<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addSingleSelectValidator("Contacts.685000007074687", "Please select 1 item", { isReqFunc: true, disabled: true });
// ]]>
</script>
											</div>
										</li>
										...
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-32" class="form-control field-control">
												...
												<input id="Contacts.685000000155005" maxlength="10" name="Contacts.685000000155005" value="" type="text" />
												<script type="text/javascript">
// <![CDATA[
...
// ]]>
										...
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-34" class="form-control field-control">
												<label style="width:22em;" class="left">Country, if other than the US</label>
												<select id="Contacts.685000000131001" name="Contacts.685000000131001">
													<option selected="selected" value=""></option>
...
// ]]>
												...
												<script type="text/javascript">
// <![CDATA[
_IW.FieldDep.addDependency("Contacts.685000000131001", "Contacts.685000000130005", {"":[""],"HOLY SEE":["VT"],"MOROCCO":["MO"],"LATVIA":["LG"],"CAPE VERDE":["CV"],"MALI":["ML"],"INDIA":["IN"],"FINLAND":["FI"],"DENMARK":["DA"],"TANZANIA":["TZ"],"BURKINA FASO":["UV"],"CZECH REPUBLIC":["EZ"],"SCOTLAND":[""],"ARGENTINA":["AR"],"SLOVENIA":["SI"],"ECUADOR":["EC"],"VENEZUELA":["VE"],"TIMOR-LESTE":["TT"],"SUDAN":["SU"],"BARBADOS":["BB"],"EL SALVADOR":["ES"],"ZAMBIA":["ZA"],"TOGO":["TO"],"CHILE":["CI"],"TAIWAN":[""],"NAMIBIA":["WA"],"BRUNEI":["BX"],"MALAYSIA":["MY"],"TUVALU":["TV"],"FRANCE":["FR"],"CANADA":["CA"],"AFGHANISTAN":["AF"],"PANAMA":["PM"],"DOMINICAN REPUBLIC":["DR"],"HONDURAS":["HO"],"AUSTRIA":["AU"],"TONGA":["TN"],"CAYMAN ISLANDS":[""],"DOMINICA":["DO"],"UNITED KINGDOM":["UK"],"ANGOLA":["AO"],"HONG KONG":[""],"FIJI":["FJ"],"CENTRAL AFRICAN REPUBLIC":["CT"],"SOLOMON ISLANDS":["BP"],"ERITREA":["ER"],"JORDAN":["JO"],"CYPRUS":["CY"],"SURINAME":["NS"],"LESOTHO":["LT"],"GAMBIA, THE":["GA"],"COLOMBIA":["CO"],"VANUATU":["NH"],"AUSTRALIA":["AS"],"ARUBA":[""],"SOUTH SUDAN":["OD"],"GERMANY":["GM"],"MARSHALL ISLANDS":["RM"],"NORTHERN IRELAND":[""],"MONGOLIA":["MG"],"GUINEA-BISSAU":["PU"],"SAINT LUCIA":["ST"],"PAKISTAN":["PK"],"UZBEKISTAN":["UZ"],"KOREA, NORTH":["KN"],"BURUNDI":["BY"],"BULGARIA":["BU"],"RWANDA":["RW"],"ENGLAND":[""],"CURACAO":[""],"ALGERIA":["AG"],"BAHAMAS, THE":["BF"],"SWEDEN":["SW"],"KIRIBATI":["KR"],"TRINIDAD AND TOBAGO":["TD"],"KYRGYZSTAN":["KG"],"PORTUGAL":["PO"],"SYRIA":["SY"],"SPAIN":["SP"],"NIGERIA":["NI"],"TAHITI":[""],"PHILIPPINES":["RP"],"TURKMENISTAN":["TX"],"AZERBAIJAN":["AJ"],"ZIMBABWE":["ZI"],"MICRONESIA":["FM"],"LEBANON":["LE"],"YEMEN":["YM"],"ETHIOPIA":["ET"],"BOTSWANA":["BC"],"NAURU":["NR"],"MAURITIUS":["MP"],"VIETNAM":["VM"],"MEXICO":["MX"],"GHANA":["GH"],"PERU":["PE"],"SEYCHELLES":["SE"],"ARMENIA":["AM"],"ISRAEL":["IS"],"TAJIKISTAN":["TI"],"NEW ZEALAND":["NZ"],"CHAD":["CD"],"KUWAIT":["KU"],"ITALY":["IT"],"PAPUA NEW GUINEA":["PP"],"SAINT KITTS AND NEVIS":["SC"],"CAMEROON":["CM"],"MALDIVES":["MV"],"ROMANIA":["RO"],"TUNISIA":["TS"],"HUNGARY":["HU"],"MACEDONIA":["MK"],"BELGIUM":["BE"],"SAO TOME AND PRINCIPE":["TP"],"BAHRAIN":["BA"],"BELARUS":["BO"],"GREECE":["GR"],"GABON":["GB"],"PALESTINE":[""],"LIBYA":["LY"],"KENYA":["KE"],"SAINT VINCENT AND THE GRENADINES":["VC"],"MONTENEGRO":["MJ"],"SAMOA":["WS"],"GRENADA":["GJ"],"TURKEY":["TU"],"GUYANA":["GY"],"UGANDA":["UG"],"ICELAND":["IC"],"SOMALIA":["SO"],"SWITZERLAND":["SZ"],"ANDORRA":["AN"],"PALAU":["PS"],"MALTA":["MT"],"SENEGAL":["SG"],"SAUDI ARABIA":["SA"],"URUGUAY":["UY"],"SINGAPORE":["SN"],"COSTA RICA":["CS"],"IRELAND":["EI"],"LUXEMBOURG":["LU"],"ANTIGUA AND BARBUDA":["AC"],"CUBA":["CU"],"SLOVAKIA":["LO"],"IRAN":["IR"],"PARAGUAY":["PA"],"BRAZIL":["BR"],"JAMAICA":["JM"],"BOSNIA AND HERZEGOVINA":["BK"],"IRAQ":["IZ"],"SIERRA LEONE":["SL"],"NICARAGUA":["NU"],"NIGER":["NG"],"NORWAY":["NO"],"SAN MARINO":["SM"],"ANGUILLA":[""],"MAURITANIA":["MR"],"LITHUANIA":["LH"],"CHINA":["CH"],"MADAGASCAR":["MA"],"GUINEA":["GV"],"COMOROS":["CN"],"BOLIVIA":["BL"],"LIBERIA":["LI"],"HAITI":["HA"],"ESTONIA":["EN"],"JAPAN":["JA"],"DJIBOUTI":["DJ"],"ALBANIA":["AL"],"SWAZILAND":["WZ"],"LAOS":["LA"],"GEORGIA":["GG"],"MALAWI":["MI"],"EQUATORIAL GUINEA":["EK"],"CONGO (BRAZZAVILLE)":["CF"],"NEPAL":["NP"],"KAZAKHSTAN":["KZ"],"LIECHTENSTEIN":["LS"],"POLAND":["PL"],"BURMA":["BM"],"UKRAINE":["UP"],"GUATEMALA":["GT"],"SRI LANKA":["CE"],"BELIZE":["BH"],"THAILAND":["TH"],"KOREA, SOUTH":["KS"],"MONACO":["MN"],"SINT MAARTEN":[""],"CÔTE D'IVOIRE":["IV"],"MACAU":[""],"BHUTAN":["BT"],"SERBIA":["RI"],"RUSSIA":["RS"],"MONTSERRAT":[""],"NETHERLANDS":["NL"],"CAMBODIA":["CB"],"BERMUDA":[""],"INDONESIA":["ID"],"MOZAMBIQUE":["MZ"],"EGYPT":["EG"],"BENIN":["BN"],"CONGO (KINSHASA)":["CG"],"CROATIA":["HR"],"QATAR":["QA"],"OMAN":["MU"],"MOLDOVA":["MD"],"WALES":[""],"KOSOVO":["KV"],"BANGLADESH":["BG"],"SOUTH AFRICA":["SF"],"UNITED ARAB EMIRATES":["AE"]});
// ]]>
</script>
											</div>
										</li>
										...
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-40" class="form-control field-control">
												<label class="left">Home Phone</label>
												<input id="Contacts.685000000003027" maxlength="50" name="Contacts.685000000003027" value="" type="text" />
												<script type="text/javascript">
// <![CDATA[
...
// ]]>
										...
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-38" class="form-control field-control">
												...
												<input id="Contacts.685000000003031" maxlength="30" name="Contacts.685000000003031" value="" type="text" />
												<script type="text/javascript">
// <![CDATA[
...
// ]]>
										...
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-36" class="form-control field-control">
												<label class="left">Preferred Phone</label>
												<select id="Contacts.685000007210315" name="Contacts.685000007210315">
													<option selected="selected" value=""></option>
												...
												<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addSingleSelectValidator("Contacts.685000007210315", "Please select 1 item", { isReqFunc: true, disabled: true });
// ]]>
</script>
											</div>
										</li>
										...
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-42" class="form-control field-control">
												<label class="dynamic-form-required left">* Country of Birth</label>
												<select id="Contacts.685000007145923" name="Contacts.685000007145923"> 
													<option selected="selected" value=""></option>
                                                	<option value="United States">United States</option>													<option value="Afghanistan">Afghanistan</option>
													<option value="Albania">Albania</option>
													<option value="Algeria">Algeria</option>
													<option value="Andorra">Andorra</option>
													<option value="Angola">Angola</option>
												...
												<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addSingleSelectValidator("Contacts.685000007145923", "Please select 1 item", { isReqFunc: true });
// ]]>
</script>
											</div>
										</li>
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-44" class="form-control field-control">
												<label style="width:18em; max-width: 130px !important;" class="left">Number of years in US</label>
												<input id="Contacts.685000007210389" maxlength="2" name="Contacts.685000007210389" value="" type="text" />
												<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Contacts.685000007210389", "notEmpty", null, { trim: true, isReqFunc: true, disabled: true });
// ]]>
</script>
												<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Contacts.685000007210389", "isInteger", null, { trim: true, emptyvalid: true });
// ]]>
</script>
												<script type="text/javascript">
// <![CDATA[
...
// ]]>
							...
							<li class="page-child-wrapper">
								<div id="IWDF-control-46" sectiontitle="Employment Information" class="form-control section-control page-child">
								 <div style="font-weight: bold">Employment Information</div>
									<ul class="control-child-helper control-draggable clearfix wide">
										<li class="clear-float"></li>
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-48" class="form-control field-control">
												<label style="width:22em;" class="left">Current Employer</label>
												<input id="Contacts.685000007346037" maxlength="30" name="Contacts.685000007346037" value="" type="text" />
												<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Contacts.685000007346037", "notEmpty", null, { trim: true, isReqFunc: true, disabled: true });
// ]]>
</script>
											</div>
										</li>
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-50" class="form-control field-control">
												...
												<input id="Contacts.685000000003023" maxlength="100" name="Contacts.685000000003023" value="" type="text" />
												<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Contacts.685000000003023", "notEmpty", null, { trim: true, isReqFunc: true, disabled: true });
// ]]>
</script>
											</div>
										</li>
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-52" class="form-control field-control">
												<label class="left">Industry</label>
												<select id="Contacts.685000007145797" name="Contacts.685000007145797">
													<option selected="selected" value=""></option>
													...
													<option value="Nonclassifiable">Nonclassifiable</option>
												...
												<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addSingleSelectValidator("Contacts.685000007145797", "Please select 1 item", { isReqFunc: true, disabled: true });
// ]]>
</script>
											</div>
										</li>
										...
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-54" class="form-control field-control">
												<label class="left">Occupation</label>
												<select id="Contacts.685000007210407" name="Contacts.685000007210407">
													<option selected="selected" value=""></option>
													...
													<option value="Entry level manager">Entry level manager</option>
													<option value="Para-Professionals">Para-Professionals</option>
													<option value="Part time">Part time</option>
													<option value="Adjunct Professor">Adjunct Professor</option>
													<option value="Associate Professor">Associate Professor</option>
													<option value="Professor">Professor</option>
													<option value="Professional">Professional</option>
													<option value="Protective Service Workers">Protective Service Workers</option>
													<option value="Partner">Partner</option>
													<option value="Retired">Retired</option>
													<option value="Skilled Craft Workers">Skilled Craft Workers</option>
													<option value="Self employed">Self employed</option>
													<option value="Senior level executive">Senior level executive</option>
													<option value="Service/Maintenance Workers">Service/Maintenance Workers</option>
													<option value="Spouse employer">Spouse employer</option>
													<option value="Technicians">Technicians</option>
												</select>
												<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addSingleSelectValidator("Contacts.685000007210407", "Please select 1 item", { isReqFunc: true, disabled: true });
// ]]>
</script>
											</div>
										</li>
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-56" class="form-control field-control">
												<label class="left">Work Email</label>
												<input id="Contacts.685000007210341" maxlength="100" name="Contacts.685000007210341" value="" type="text" />
												<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Contacts.685000007210341", "validEmail", null, { trim: true, emptyvalid: true });
// ]]>
</script>
												<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Contacts.685000007210341", "notEmpty", null, { trim: true, isReqFunc: true, disabled: true });
// ]]>
</script>
											</div>
										</li>
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-58" class="form-control field-control">
												<label class="left">Work Phone</label>
												<input id="Contacts.685000007210339" maxlength="17" name="Contacts.685000007210339" value="" type="text" />
												<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Contacts.685000007210339", "notEmpty", null, { trim: true, isReqFunc: true, disabled: true });
// ]]>
</script>
											</div>
										</li>
                        ...
                        <fieldset style="background:#f4f4f4; border-radius: 10px !important; margin-bottom:10px;">
                          <legend>Education</legend>
							<li class="page-child-wrapper">
								<div id="IWDF-control-60-null" class="form-control page-child">
									<div id="IWDF-wrapper-103">
										<div id="IWDF-control-60-IWDF-row-105" sectiontitle="Undergraduate Studies (if any)" style="margin-bottom:10px;" class="form-control section-control">
											<div class="title clearfix">
												<span>Undergraduate Studies (if any)</span>
												<a style="display:none;float:right;" class="right-link right-link" onclick="_IW.FormsRuntime.removeSection(&quot;IWDF-control-60-IWDF-row-105&quot;, &quot;IWDF-link-104&quot;)" href="javascript:void(0)">Remove Entry</a>
											</div>
											<ul class="control-child-helper control-draggable clearfix wide">
												<li class="clear-float"></li>
												<li class="control-draggable control-child-wrapper wide">
													<div id="IWDF-control-62" class="form-control richtext-control">Please list all institutions of higher education, if any.</div>
												</li>
												<li class="clear-float"></li>
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-64" class="form-control field-control">
														<label style="width:14em;" class="top">Institution Name</label>
														<input id="EducationHistory.Undergraduate.records.IWDF-row-105.685000000002963" maxlength="100" name="EducationHistory.Undergraduate.records.IWDF-row-105.685000000002963" value="" type="text" />
														<script type="text/javascript">
// <![CDATA[
// _IW.FormValidator.addTextFieldValidator("EducationHistory.Undergraduate.records.IWDF-row-105.685000000002963", "notEmpty", null, { trim: true, isReqFunc: true });
// ]]>
</script>
													</div>
												</li>
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-66" class="form-control field-control">
														<label class="top">Degree received</label>
														<select id="EducationHistory.Undergraduate.records.IWDF-row-105.685000007212273" name="EducationHistory.Undergraduate.records.IWDF-row-105.685000007212273">
															<option selected="selected" value=""></option>
														...
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addSingleSelectValidator("EducationHistory.Undergraduate.records.IWDF-row-105.685000007212273", "Please select 1 item", { isReqFunc: true, disabled: true });
// ]]>
</script>
													</div>
												</li>
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-68" class="form-control field-control">
														<label class="top">First attended</label>
														<input id="EducationHistory.Undergraduate.records.IWDF-row-105.685000007759075" maxlength="100" name="EducationHistory.Undergraduate.records.IWDF-row-105.685000007759075" value="" type="text" />
														<br />
														<span style="color:rgb(0, 0, 0);">[mm/yyyy]</span>
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("EducationHistory.Undergraduate.records.IWDF-row-105.685000007759075", "validMonthYear", null, { trim: true, emptyvalid: true });
// ]]>
</script>
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("EducationHistory.Undergraduate.records.IWDF-row-105.685000007759075", "notEmpty", null, { trim: true, isReqFunc: true, disabled: true });
// ]]>
</script>
													</div>
												</li>
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-70" class="form-control field-control">
														<label class="top">Last attended</label>
														<input id="EducationHistory.Undergraduate.records.IWDF-row-105.685000007759077" maxlength="100" name="EducationHistory.Undergraduate.records.IWDF-row-105.685000007759077" value="" type="text" />
														<br />
														<span style="color:rgb(0, 0, 0);">[mm/yyyy]</span>
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("EducationHistory.Undergraduate.records.IWDF-row-105.685000007759077", "validMonthYear", null, { trim: true, emptyvalid: true });
// ]]>
</script>
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("EducationHistory.Undergraduate.records.IWDF-row-105.685000007759077", "notEmpty", null, { trim: true, isReqFunc: true, disabled: true });
// ]]>
</script>
													</div>
												</li>
												<li class="clear-float"></li>
												<li class="control-draggable control-child-wrapper wide">
													<div id="IWDF-control-72" class="form-control richtext-control">
														<div style="margin-left: 6px; margin-top: 10px;">If you have attended an additional institution during your undergraduate education, please use the &quot;Add another undergraduate institution&quot; link to the right.  Otherwise, please proceed to the next section.</div>
													</div>
												</li>
												<li class="clear-float"></li>
												...
												<li class="control-child-wrapper">
													<div id="IWDF-control-74" class="form-control hidden field-control">
														<label class="top">CEEB Code</label>
														<input id="EducationHistory.Undergraduate.records.IWDF-row-105.685000000002975" maxlength="10" name="EducationHistory.Undergraduate.records.IWDF-row-105.685000000002975" value="" type="text" readonly="readonly" />
													</div>
												</li>
												<li class="control-child-wrapper">
													<div id="IWDF-control-76" class="form-control hidden field-control">
														<label class="top">Education Type</label>
														<select id="EducationHistory.Undergraduate.records.IWDF-row-105.685000000056005" name="EducationHistory.Undergraduate.records.IWDF-row-105.685000000056005" disabled="disabled">
															<option value=""></option>
											...
											<script type="text/javascript">
// <![CDATA[
_IW.InlineLookup.bind("EducationHistory.Undergraduate.records.IWDF-row-105.685000000002963", {"lookupType":"organizations","orgLookupFilter":["College or University","Graduate School"]}, function(field, oneResult) { _IW.FormsRuntime.inlineLookupSelected(field, oneResult, "685000000002963"); }, { });
// ]]>
</script>
										</div>
									</div>
									<div style="text-align:right;">
										<a id="IWDF-link-104" style="display:inline;font-weight:bold;" onclick="_IW.FormsRuntime.duplicateSection(&quot;IWDF-wrapper-103&quot;, &quot;EducationHistory.Undergraduate&quot;)" href="javascript:void(0)">Add another undergraduate institution</a>
									</div>
									<script type="text/javascript">
// <![CDATA[
_IW.FormsRuntime.setTemplate("EducationHistory.Undergraduate", "<div id=\"IWDF-control-60-RepeatingSectionControlMagicString\" sectionTitle=\"Undergraduate Studies (additional)\" style=\"margin-bottom:10px;\" class=\"form-control section-control\"><div class=\"title clearfix\"><span>Undergraduate Studies (additional)<\/span>\n<a style=\"display:inline;float:right;\" class=\"right-link\" onclick=\"_IW.FormsRuntime.removeSection(&quot;IWDF-control-60-RepeatingSectionControlMagicString&quot;, &quot;IWDF-link-104&quot;)\" href=\"javascript:void(0)\">Remove Entry<\/a>\n<\/div>\n<ul class=\"control-child-helper control-draggable clearfix wide\"><li class=\"clear-float\"><\/li>\n<li class=\"control-draggable control-child-wrapper wide\"><div id=\"IWDF-control-62\" class=\"form-control richtext-control\">Please list all institutions of higher education, if any.<\/div>\n<\/li>\n<li class=\"clear-float\"><\/li>\n<li class=\"control-draggable control-child-wrapper\"><div id=\"IWDF-control-64\" class=\"form-control field-control\"><label style=\"width:14em;\" class=\"dynamic-form-required top\">* Institution Name<\/label>\n<input id=\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000000002963\" maxlength=\"100\" name=\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000000002963\" value=\"\" type=\"text\"\/><script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addTextFieldValidator(\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000000002963\", \"notEmpty\", null, { trim: true, isReqFunc: true });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n<\/li>\n<li class=\"control-draggable control-child-wrapper\"><div id=\"IWDF-control-66\" class=\"form-control field-control\"><label class=\"top\">Degree received<\/label>\n<select id=\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000007212273\" name=\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000007212273\"><option selected=\"selected\" value=\"\"><\/option>\n<option value=\"Bachelor\">Bachelor<\/option>\n<option value=\"Master\">Master<\/option>\n<option value=\"Doctorate\">Doctorate<\/option>\n<\/select>\n<script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addSingleSelectValidator(\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000007212273\", \"Please select 1 item\", { isReqFunc: true, disabled: true });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n<\/li>\n<li class=\"control-draggable control-child-wrapper\"><div id=\"IWDF-control-68\" class=\"form-control field-control\"><label class=\"top\">First attended<\/label>\n<input id=\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000007759075\" maxlength=\"100\" name=\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000007759075\" value=\"\" type=\"text\"\/><br\/><span style=\"color:rgb(0, 0, 0);\">[mm\/yyyy]<\/span>\n<script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addTextFieldValidator(\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000007759075\", \"validMonthYear\", null, { trim: true, emptyvalid: true });\n\/\/ ]]&gt;\n<\/script>\n<script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addTextFieldValidator(\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000007759075\", \"notEmpty\", null, { trim: true, isReqFunc: true, disabled: true });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n<\/li>\n<li class=\"control-draggable control-child-wrapper\"><div id=\"IWDF-control-70\" class=\"form-control field-control\"><label class=\"top\">Last attended<\/label>\n<input id=\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000007759077\" maxlength=\"100\" name=\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000007759077\" value=\"\" type=\"text\"\/><br\/><span style=\"color:rgb(0, 0, 0);\">[mm\/yyyy]<\/span>\n<script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addTextFieldValidator(\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000007759077\", \"validMonthYear\", null, { trim: true, emptyvalid: true });\n\/\/ ]]&gt;\n<\/script>\n<script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addTextFieldValidator(\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000007759077\", \"notEmpty\", null, { trim: true, isReqFunc: true, disabled: true });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n<\/li>\n<li class=\"clear-float\"><\/li>\n<li class=\"control-draggable control-child-wrapper wide\"><div id=\"IWDF-control-72\" class=\"form-control richtext-control\"><div style=\"margin-left: 6px; margin-top: 10px;\">If you have attended an additional institution during your undergraduate education, please use the &quot;Add another undergraduate institution&quot; link to the right.&nbsp; Otherwise, please proceed to the next section.<\/div>\n<\/div>\n<\/li>\n<li class=\"clear-float\"><\/li>\n<li class=\"control-draggable control-child-wrapper\"><\/li>\n<li class=\"clear-float\"><\/li>\n<li class=\"control-draggable control-child-wrapper\"><\/li>\n<li class=\"control-child-wrapper\"><div id=\"IWDF-control-74\" class=\"form-control hidden field-control\"><label class=\"top\">CEEB Code<\/label>\n<input id=\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000000002975\" maxlength=\"10\" name=\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000000002975\" value=\"\" type=\"text\" readonly=\"readonly\"\/><\/div>\n<\/li>\n<li class=\"control-child-wrapper\"><div id=\"IWDF-control-76\" class=\"form-control hidden field-control\"><label class=\"top\">Education Type<\/label>\n<select id=\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000000056005\" name=\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000000056005\" disabled=\"disabled\"><option value=\"\"><\/option>\n<option value=\"High School\">High School<\/option>\n<option value=\"Certificate\">Certificate<\/option>\n<option selected=\"selected\" value=\"Undergraduate\">Undergraduate<\/option>\n<option value=\"Graduate\">Graduate<\/option>\n<option value=\"Doctorate\">Doctorate<\/option>\n<option value=\"Middle\/Junior High School\">Middle\/Junior High School<\/option>\n<\/select>\n<\/div>\n<\/li>\n<\/ul>\n<script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.InlineLookup.bind(\"EducationHistory.Undergraduate.records.RepeatingSectionControlMagicString.685000000002963\", {\"lookupType\":\"organizations\",\"orgLookupFilter\":[\"College or University\",\"Graduate School\"]}, function(field, oneResult) { _IW.FormsRuntime.inlineLookupSelected(field, oneResult, \"685000000002963\"); }, { });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n");
// ]]>
</script>
									<input name="EducationHistory.Undergraduate.myType" value="Undergraduate" type="hidden" />
								</div>
							</li>
							<li class="page-child-wrapper">
								<div id="IWDF-control-78-null" class="form-control page-child">
									<div id="IWDF-wrapper-106">
										<div id="IWDF-control-78-IWDF-row-108" sectiontitle="Graduate Studies (if any)" style="margin-bottom:10px;" class="form-control section-control">
											<div class="title clearfix">
												<span>Graduate Studies (if any)</span>
												<a style="display:none;float:right;" class="right-link right-link" onclick="_IW.FormsRuntime.removeSection(&quot;IWDF-control-78-IWDF-row-108&quot;, &quot;IWDF-link-107&quot;)" href="javascript:void(0)">Remove Entry</a>
											</div>
											<ul class="control-child-helper control-draggable clearfix wide">
												<li class="clear-float"></li>
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-80" class="form-control field-control">
														<label style="width:14em;" class="top">Institution Name</label>
														<input id="EducationHistory.Graduate.records.IWDF-row-108.685000000002963" maxlength="100" name="EducationHistory.Graduate.records.IWDF-row-108.685000000002963" value="" type="text" />
														<script type="text/javascript">
// <![CDATA[
//_IW.FormValidator.addTextFieldValidator("EducationHistory.Graduate.records.IWDF-row-108.685000000002963", "notEmpty", null, { trim: true, isReqFunc: true });
// ]]>
</script>
													</div>
												</li>
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-82" class="form-control field-control">
														<label class="top">Degree received</label>
														<select id="EducationHistory.Graduate.records.IWDF-row-108.685000007212273" name="EducationHistory.Graduate.records.IWDF-row-108.685000007212273">
															<option selected="selected" value=""></option>
															<option value="Associate">Associate</option>
															<option value="Bachelor">Bachelor</option>
															<option value="Master">Master</option>
														...
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addSingleSelectValidator("EducationHistory.Graduate.records.IWDF-row-108.685000007212273", "Please select 1 item", { isReqFunc: true, disabled: true });
// ]]>
</script>
													</div>
												</li>
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-84" class="form-control field-control">
														<label class="top">First attended</label>
														<input id="EducationHistory.Graduate.records.IWDF-row-108.685000007759075" maxlength="100" name="EducationHistory.Graduate.records.IWDF-row-108.685000007759075" value="" type="text" />
														<br />
														<span style="color:rgb(0, 0, 0);">[mm/yyyy]</span>
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("EducationHistory.Graduate.records.IWDF-row-108.685000007759075", "validMonthYear", null, { trim: true, emptyvalid: true });
// ]]>
</script>
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("EducationHistory.Graduate.records.IWDF-row-108.685000007759075", "notEmpty", null, { trim: true, isReqFunc: true, disabled: true });
// ]]>
</script>
													</div>
												</li>
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-86" class="form-control field-control">
														<label class="top">Last attended</label>
														<input id="EducationHistory.Graduate.records.IWDF-row-108.685000007759077" maxlength="100" name="EducationHistory.Graduate.records.IWDF-row-108.685000007759077" value="" type="text" />
														<br />
														<span style="color:rgb(0, 0, 0);">[mm/yyyy]</span>
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("EducationHistory.Graduate.records.IWDF-row-108.685000007759077", "validMonthYear", null, { trim: true, emptyvalid: true });
// ]]>
</script>
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("EducationHistory.Graduate.records.IWDF-row-108.685000007759077", "notEmpty", null, { trim: true, isReqFunc: true, disabled: true });
// ]]>
</script>
													</div>
												</li>
												<li class="clear-float"></li>
												<li class="control-draggable control-child-wrapper wide">
													<div id="IWDF-control-88" class="form-control richtext-control">
														<div style="margin-left: 6px; margin-top: 10px;">If you have attended an additional institution during your graduate education, please use the &quot;Add another graduate institution&quot; link to the right.  Otherwise, please proceed to the next section.</div>
													</div>
												</li>
												<li class="clear-float"></li>
												<li class="control-draggable control-child-wrapper"></li>
												...
												<li class="control-child-wrapper">
													<div id="IWDF-control-90" class="form-control hidden field-control">
														<label class="top">CEEB Code</label>
														<input id="EducationHistory.Graduate.records.IWDF-row-108.685000000002975" maxlength="10" name="EducationHistory.Graduate.records.IWDF-row-108.685000000002975" value="" type="text" readonly="readonly" />
													</div>
												</li>
												<li class="control-child-wrapper">
													<div id="IWDF-control-92" class="form-control hidden field-control">
														<label class="top">Education Type</label>
														<select id="EducationHistory.Graduate.records.IWDF-row-108.685000000056005" name="EducationHistory.Graduate.records.IWDF-row-108.685000000056005" disabled="disabled">
															<option value=""></option>
															<option value="High School">High School</option>
															<option value="Certificate">Certificate</option>
											...
											<script type="text/javascript">
// <![CDATA[
_IW.InlineLookup.bind("EducationHistory.Graduate.records.IWDF-row-108.685000000002963", {"lookupType":"organizations","orgLookupFilter":["College or University","Graduate School"]}, function(field, oneResult) { _IW.FormsRuntime.inlineLookupSelected(field, oneResult, "685000000002963"); }, { });
// ]]>
</script>
										</div>
									</div>
									<div style="text-align:right;">
										<a id="IWDF-link-107" style="display:inline;font-weight:bold;" onclick="_IW.FormsRuntime.duplicateSection(&quot;IWDF-wrapper-106&quot;, &quot;EducationHistory.Graduate&quot;)" href="javascript:void(0)">Add another graduate institution</a>
									</div>
									<script type="text/javascript">
// <![CDATA[
_IW.FormsRuntime.setTemplate("EducationHistory.Graduate", "<div id=\"IWDF-control-78-RepeatingSectionControlMagicString\" sectionTitle=\"Graduate Studies (additional)\" style=\"margin-bottom:10px;\" class=\"form-control section-control\"><div class=\"title clearfix\"><span>Graduate Studies (additional)<\/span>\n<a style=\"display:inline;float:right;\" class=\"right-link\" onclick=\"_IW.FormsRuntime.removeSection(&quot;IWDF-control-78-RepeatingSectionControlMagicString&quot;, &quot;IWDF-link-107&quot;)\" href=\"javascript:void(0)\">Remove Entry<\/a>\n<\/div>\n<ul class=\"control-child-helper control-draggable clearfix wide\"><li class=\"clear-float\"><\/li>\n<li class=\"control-draggable control-child-wrapper\"><div id=\"IWDF-control-80\" class=\"form-control field-control\"><label style=\"width:14em;\" class=\"dynamic-form-required top\">* Institution Name<\/label>\n<input id=\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000000002963\" maxlength=\"100\" name=\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000000002963\" value=\"\" type=\"text\"\/><script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addTextFieldValidator(\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000000002963\", \"notEmpty\", null, { trim: true, isReqFunc: true });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n<\/li>\n<li class=\"control-draggable control-child-wrapper\"><div id=\"IWDF-control-82\" class=\"form-control field-control\"><label class=\"top\">Degree received<\/label>\n<select id=\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000007212273\" name=\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000007212273\"><option selected=\"selected\" value=\"\"><\/option>\n<option value=\"Bachelor\">Bachelor<\/option>\n<option value=\"Master\">Master<\/option>\n<option value=\"Doctorate\">Doctorate<\/option>\n<\/select>\n<script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addSingleSelectValidator(\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000007212273\", \"Please select 1 item\", { isReqFunc: true, disabled: true });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n<\/li>\n<li class=\"control-draggable control-child-wrapper\"><div id=\"IWDF-control-84\" class=\"form-control field-control\"><label class=\"top\">First attended<\/label>\n<input id=\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000007759075\" maxlength=\"100\" name=\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000007759075\" value=\"\" type=\"text\"\/><br\/><span style=\"color:rgb(0, 0, 0);\">[mm\/yyyy]<\/span>\n<script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addTextFieldValidator(\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000007759075\", \"validMonthYear\", null, { trim: true, emptyvalid: true });\n\/\/ ]]&gt;\n<\/script>\n<script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addTextFieldValidator(\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000007759075\", \"notEmpty\", null, { trim: true, isReqFunc: true, disabled: true });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n<\/li>\n<li class=\"control-draggable control-child-wrapper\"><div id=\"IWDF-control-86\" class=\"form-control field-control\"><label class=\"top\">Last attended<\/label>\n<input id=\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000007759077\" maxlength=\"100\" name=\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000007759077\" value=\"\" type=\"text\"\/><br\/><span style=\"color:rgb(0, 0, 0);\">[mm\/yyyy]<\/span>\n<script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addTextFieldValidator(\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000007759077\", \"validMonthYear\", null, { trim: true, emptyvalid: true });\n\/\/ ]]&gt;\n<\/script>\n<script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addTextFieldValidator(\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000007759077\", \"notEmpty\", null, { trim: true, isReqFunc: true, disabled: true });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n<\/li>\n<li class=\"clear-float\"><\/li>\n<li class=\"control-draggable control-child-wrapper wide\"><div id=\"IWDF-control-88\" class=\"form-control richtext-control\"><div style=\"margin-left: 6px; margin-top: 10px;\">If you have attended an additional institution during your graduate education, please use the &quot;Add another graduate institution&quot; link to the right.&nbsp; Otherwise, please proceed to the next section.<\/div>\n<\/div>\n<\/li>\n<li class=\"clear-float\"><\/li>\n<li class=\"control-draggable control-child-wrapper\"><\/li>\n<li class=\"clear-float\"><\/li>\n<li class=\"control-draggable control-child-wrapper\"><\/li>\n<li class=\"control-child-wrapper\"><div id=\"IWDF-control-90\" class=\"form-control hidden field-control\"><label class=\"top\">CEEB Code<\/label>\n<input id=\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000000002975\" maxlength=\"10\" name=\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000000002975\" value=\"\" type=\"text\" readonly=\"readonly\"\/><\/div>\n<\/li>\n<li class=\"control-child-wrapper\"><div id=\"IWDF-control-92\" class=\"form-control hidden field-control\"><label class=\"top\">Education Type<\/label>\n<select id=\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000000056005\" name=\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000000056005\" disabled=\"disabled\"><option value=\"\"><\/option>\n<option value=\"High School\">High School<\/option>\n<option value=\"Certificate\">Certificate<\/option>\n<option value=\"Undergraduate\">Undergraduate<\/option>\n<option selected=\"selected\" value=\"Graduate\">Graduate<\/option>\n<option value=\"Doctorate\">Doctorate<\/option>\n<option value=\"Middle\/Junior High School\">Middle\/Junior High School<\/option>\n<\/select>\n<\/div>\n<\/li>\n<\/ul>\n<script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.InlineLookup.bind(\"EducationHistory.Graduate.records.RepeatingSectionControlMagicString.685000000002963\", {\"lookupType\":\"organizations\",\"orgLookupFilter\":[\"College or University\",\"Graduate School\"]}, function(field, oneResult) { _IW.FormsRuntime.inlineLookupSelected(field, oneResult, \"685000000002963\"); }, { });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n");
// ]]>
</script>
									<input name="EducationHistory.Graduate.myType" value="Graduate" type="hidden" />
								</div>
							</li>
							 </fieldset>
                              <li class="page-child-wrapper" style="display:none">
								<div id="IWDF-control-94-null" class="form-control page-child">
									<div id="IWDF-wrapper-109">
										<div id="IWDF-control-94-IWDF-row-111" sectiontitle="Connections" style="margin-bottom:10px;" class="form-control section-control">
											<div class="title clearfix">
												<span>Connections</span>
												<a style="display:inline;float:right;" class="right-link right-link" onclick="_IW.FormsRuntime.removeSection(&quot;IWDF-control-94-IWDF-row-111&quot;, &quot;IWDF-link-110&quot;)" href="javascript:void(0)">Remove Entry</a>
											</div>
											<ul class="control-child-helper control-draggable clearfix wide">
												<li class="clear-float"></li>
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-96" class="form-control field-control">
														<label class="dynamic-form-required top">* Last Name</label>
														<input id="Connections.-None-.records.IWDF-row-111.685000000003017" maxlength="80" name="Connections.-None-.records.IWDF-row-111.685000000003017" value="<?php echo($_REQUEST['stdt_lname']);?>" type="text" />
														<script type="text/javascript">
// <![CDATA[
//_IW.FormValidator.addTextFieldValidator("Connections.-None-.records.IWDF-row-111.685000000003017", "notEmpty", null, { trim: true, isReqFunc: true });
// ]]>
</script>
													</div>
												</li>
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-98" class="form-control field-control">
														<label class="dynamic-form-required top">* Connection Type</label>
														<select id="Connections.-None-.records.IWDF-row-111.685000000029363" name="Connections.-None-.records.IWDF-row-111.685000000029363">
															<option value=""></option>
															<option selected="selected" value="Parent to Child">Parent to Child</option>
														...
														<script type="text/javascript">
// <![CDATA[
// _IW.FormValidator.addSingleSelectValidator("Connections.-None-.records.IWDF-row-111.685000000029363", "Please select 1 item", { isReqFunc: true });
// ]]>
</script>
													</div>
												</li>
												<li class="clear-float"></li>
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-100" class="form-control field-control">
														<label class="top">Email</label>
														<input id="Connections.-None-.records.IWDF-row-111.685000000003021" maxlength="100" name="Connections.-None-.records.IWDF-row-111.685000000003021" value="<?php echo($_REQUEST['stdt_eml']);?>" type="text" />
														<script type="text/javascript">
// <![CDATA[
//_IW.FormValidator.addTextFieldValidator("Connections.-None-.records.IWDF-row-111.685000000003021", "validEmail", null, { trim: true, emptyvalid: true });
// ]]>
</script>
														<script type="text/javascript">
// <![CDATA[
//_IW.FormValidator.addTextFieldValidator("Connections.-None-.records.IWDF-row-111.685000000003021", "notEmpty", null, { trim: true, isReqFunc: true, disabled: true });
// ]]>
</script>
													</div>
												</li>
									...
									<div style="text-align:right;">
										<a id="IWDF-link-110" style="display:inline;font-weight:bold;" onclick="_IW.FormsRuntime.duplicateSection(&quot;IWDF-wrapper-109&quot;, &quot;Connections.-None-&quot;)" href="javascript:void(0)">Add Another Response</a>
									</div>
									<script type="text/javascript">
// <![CDATA[
_IW.FormsRuntime.setTemplate("Connections.-None-", "<div id=\"IWDF-control-94-RepeatingSectionControlMagicString\" sectionTitle=\"Connections\" style=\"margin-bottom:10px;\" class=\"form-control section-control\"><div class=\"title clearfix\"><span>Connections<\/span>\n<a style=\"display:inline;float:right;\" class=\"right-link\" onclick=\"_IW.FormsRuntime.removeSection(&quot;IWDF-control-94-RepeatingSectionControlMagicString&quot;, &quot;IWDF-link-110&quot;)\" href=\"javascript:void(0)\">Remove Entry<\/a>\n<\/div>\n<ul class=\"control-child-helper control-draggable clearfix wide\"><li class=\"clear-float\"><\/li>\n<li class=\"control-draggable control-child-wrapper\"><div id=\"IWDF-control-96\" class=\"form-control field-control\"><label class=\"dynamic-form-required top\">* Last Name<\/label>\n<input id=\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000003017\" maxlength=\"80\" name=\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000003017\" value=\"\" type=\"text\"\/><script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addTextFieldValidator(\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000003017\", \"notEmpty\", null, { trim: true, isReqFunc: true });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n<\/li>\n<li class=\"control-draggable control-child-wrapper\"><div id=\"IWDF-control-98\" class=\"form-control field-control\"><label class=\"dynamic-form-required top\">* Connection Type<\/label>\n<select id=\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000029363\" name=\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000029363\"><option value=\"\"><\/option>\n<option selected=\"selected\" value=\"Parent to Child\">Parent to Child<\/option>\n<option value=\"Child to Parent\">Child to Parent<\/option>\n<option value=\"Friend to Friend\">Friend to Friend<\/option>\n<option value=\"Emergency Contact to Emergency Contact\">Emergency Contact to Emergency Contact<\/option>\n<option value=\"Colleague to Colleague\">Colleague to Colleague<\/option>\n<option value=\"Spouse to Spouse\">Spouse to Spouse<\/option>\n<option value=\"Guardian to Dependant\">Guardian to Dependant<\/option>\n<option value=\"Dependant to Guardian\">Dependant to Guardian<\/option>\n<option value=\"Parent to Parent\">Parent to Parent<\/option>\n<option value=\"Teacher to Student\">Teacher to Student<\/option>\n<option value=\"Advisor to Student\">Advisor to Student<\/option>\n<\/select>\n<script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addSingleSelectValidator(\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000029363\", \"Please select 1 item\", { isReqFunc: true });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n<\/li>\n<li class=\"clear-float\"><\/li>\n<li class=\"control-draggable control-child-wrapper\"><div id=\"IWDF-control-100\" class=\"form-control field-control\"><label class=\"top\">Email<\/label>\n<input id=\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000003021\" maxlength=\"100\" name=\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000003021\" value=\"\" type=\"text\"\/><script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addTextFieldValidator(\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000003021\", \"validEmail\", null, { trim: true, emptyvalid: true });\n\/\/ ]]&gt;\n<\/script>\n<script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addTextFieldValidator(\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000003021\", \"notEmpty\", null, { trim: true, isReqFunc: true, disabled: true });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n<\/li>\n<\/ul>\n<\/div>\n");
// ]]>
</script>
									<input name="Connections.-None-.myType" value="-None-" type="hidden" />
								</div>
							</li>
						</ul>
					</div>
				...
				<fieldset>
                    <legend>Parent/Guardian Perspective on Applicant's Development</legend>
                        <p>As a parent or guardian, you have a unique perspective on the applicant 
                        that we both need and value in assessing the candidate's readiness to 
                        enter college early. Please respond to the following topics. Describe 
                        the applicant's relationship/interactions with family members, teachers, 
                        and mentors who have influenced the candidate's development and 
                        individuality. Assess the candidate's emotional and social maturity as 
                        they pertain to living away from home. Discuss any other event or 
                        circumstances that you believe will have an impact on the applicant's 
                        success at Simon's Rock.</p>
					<iframe name="uploadFrame" id="uploadFrame" src="upload.php?stdt_lname=<?php echo($stdt_lname); ?>&stdt_eml=<?php echo($stdt_eml); ?>" frameborder="0" height="250" scrolling="no" width="450"></iframe>
			    </fieldset>
				...
				<div class="form-action-bar bottom">
					...
					<div class="middle-buttons">
						<button class="submit fg-button ui-state-default ui-corner-all" onclick="disp_confirm(this.form);" type="button"
                        	id="submitButton" style="padding: 10px; font-size: 1.5em; font-weight: bold; border: 2px solid;">Submit</button>
						<!-- <button class="cancel last fg-button ui-state-default ui-corner-all" onclick="_IW.FormsRuntime.cancel();" type="button">Cancel</button> -->
					</div>
				</div>
			</form>

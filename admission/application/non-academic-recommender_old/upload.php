...
-->
			...
			<div id="IWDF-dialog-14" title="Please select your file" style="display:none;">
				<form enctype="multipart/form-data" target="IWDF-frame-15" method="post">
					...
					<p></p>
					<input style="width:100%;" name="description" type="hidden" value="Non-academic Recommendation and Evaluation, upload 1" />
					...
					<input name="inquiryFormId" value="685000007346079" type="hidden" />
					<input name="domainObjectId" value="685000007346079" type="hidden" />
				</form>
			</div>
			<script type="text/javascript">
// <![CDATA[

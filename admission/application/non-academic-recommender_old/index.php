...
<br />
Please enter your information below, then upload the recommendation form and your letter, if applicable.</span>
</div>
		<div id="form-wrapper" class="ui-tabs-left">
			...
			<form target="_dummy" action="javascript:void(0);">
				<div id="IWDF-dynamicform-34" class="dynamicFormDefaults clearfix">
					<ul>
						<li>
							<a href="#IWDF-page-35">Untitled Page</a>
						</li>
					</ul>
					<div id="IWDF-page-35">
...
// ]]>
										...
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-12" class="form-control field-control">
												<label class="dynamic-form-required top">* Phone</label>
												<input id="Contacts.685000000003027" maxlength="50" name="Contacts.685000000003027" value="" type="text" />
												<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Contacts.685000000003027", "notEmpty", null, { trim: true, isReqFunc: true });
// ]]>
</script>
											</div>
										</li>
...
// ]]>
							...
							<li class="page-child-wrapper">
								<div id="IWDF-control-16-null" class="form-control page-child">
									<div id="IWDF-wrapper-36">
										<div id="IWDF-control-16-IWDF-row-38" sectiontitle="Experience" style="margin-bottom:10px;" class="form-control section-control">
											<div class="title clearfix" style="display:none;">
												<span>Experience</span>
												<a style="display:inline;float:right;" class="right-link right-link" onclick="_IW.FormsRuntime.removeSection(&quot;IWDF-control-16-IWDF-row-38&quot;, &quot;IWDF-link-37&quot;)" href="javascript:void(0)">Remove Entry</a>
											</div>
											<ul class="control-child-helper control-draggable clearfix wide">
												<li class="clear-float"></li>
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-18" class="form-control field-control">
														<label style="width:25em;" class="dynamic-form-required top">* Please list the school or organization through which you are affilliated with the student.</label>
														<input id="Experience.-None-.records.IWDF-row-38.685000000002963" maxlength="100" name="Experience.-None-.records.IWDF-row-38.685000000002963" value="" type="text" />
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Experience.-None-.records.IWDF-row-38.685000000002963", "notEmpty", null, { trim: true, isReqFunc: true });
// ]]>
</script>
													</div>
												</li>
												...
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-22" class="form-control field-control">
														...
														<input id="Experience.-None-.records.IWDF-row-38.685000000063013" maxlength="255" name="Experience.-None-.records.IWDF-row-38.685000000063013" value="" type="text" />
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Experience.-None-.records.IWDF-row-38.685000000063013", "notEmpty", null, { trim: true, isReqFunc: true });
// ]]>
</script>
													</div>
												</li>
												...
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-24" class="form-control field-control">
														<label style="width:25em;" class="dynamic-form-required top">* Please choose the value that best describes your affiliation with the school or organization</label>
														<select id="Experience.-None-.records.IWDF-row-38.685000000057003" name="Experience.-None-.records.IWDF-row-38.685000000057003">
														...
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addSingleSelectValidator("Experience.-None-.records.IWDF-row-38.685000000057003", "Please select 1 item", { isReqFunc: true });
// ]]>
</script>
													</div>
												</li>
												<li class="control-child-wrapper" style="display:none">
													<div id="IWDF-control-20" class="form-control hidden field-control">
														<label class="top">CEEB Code</label>
														<input id="Experience.-None-.records.IWDF-row-38.685000000002975" maxlength="10" name="Experience.-None-.records.IWDF-row-38.685000000002975" value="" type="text" readonly="readonly" />
													</div>
												</li>
											</ul>
											<script type="text/javascript">
// <![CDATA[
_IW.InlineLookup.bind("Experience.-None-.records.IWDF-row-38.685000000002963", {"lookupType":"organizations","orgLookupFilter":[]}, function(field, oneResult) { _IW.FormsRuntime.inlineLookupSelected(field, oneResult, "685000000002963"); }, { });
// ]]>
</script>
										</div>
									</div>
									<div style="text-align:right; display:none;">
										<a id="IWDF-link-37" style="display:none;font-weight:bold;" onclick="_IW.FormsRuntime.duplicateSection(&quot;IWDF-wrapper-36&quot;, &quot;Experience.-None-&quot;)" href="javascript:void(0)">Add Another Response</a>
									</div>
									<script type="text/javascript">
// <![CDATA[
_IW.FormsRuntime.setTemplate("Experience.-None-", "<div id=\"IWDF-control-16-RepeatingSectionControlMagicString\" sectionTitle=\"Experience\" style=\"margin-bottom:10px;\" class=\"form-control section-control\"><div class=\"title clearfix\"><span>Experience<\/span>\n<a style=\"display:inline;float:right;\" class=\"right-link\" onclick=\"_IW.FormsRuntime.removeSection(&quot;IWDF-control-16-RepeatingSectionControlMagicString&quot;, &quot;IWDF-link-37&quot;)\" href=\"javascript:void(0)\">Remove Entry<\/a>\n<\/div>\n<ul class=\"control-child-helper control-draggable clearfix wide\"><li class=\"clear-float\"><\/li>\n<li class=\"control-draggable control-child-wrapper\"><div id=\"IWDF-control-18\" class=\"form-control field-control\"><label style=\"width:25em;\" class=\"dynamic-form-required top\">* Please list the school or organization through which you are affilliated with the student.<\/label>\n<input id=\"Experience.-None-.records.RepeatingSectionControlMagicString.685000000002963\" maxlength=\"100\" name=\"Experience.-None-.records.RepeatingSectionControlMagicString.685000000002963\" value=\"\" type=\"text\"\/><script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addTextFieldValidator(\"Experience.-None-.records.RepeatingSectionControlMagicString.685000000002963\", \"notEmpty\", null, { trim: true, isReqFunc: true });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n<\/li>\n<li class=\"control-draggable control-child-wrapper\"><\/li>\n<li class=\"clear-float\"><\/li>\n<li class=\"control-draggable control-child-wrapper\"><div id=\"IWDF-control-22\" class=\"form-control field-control\"><label class=\"top\">Title\/Position<\/label>\n<input id=\"Experience.-None-.records.RepeatingSectionControlMagicString.685000000063013\" maxlength=\"255\" name=\"Experience.-None-.records.RepeatingSectionControlMagicString.685000000063013\" value=\"\" type=\"text\"\/><script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addTextFieldValidator(\"Experience.-None-.records.RepeatingSectionControlMagicString.685000000063013\", \"notEmpty\", null, { trim: true, isReqFunc: true, disabled: true });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n<\/li>\n<li class=\"clear-float\"><\/li>\n<li class=\"control-draggable control-child-wrapper\"><div id=\"IWDF-control-24\" class=\"form-control field-control\"><label style=\"width:25em;\" class=\"dynamic-form-required top\">* Please choose the value that best describes your affiliation with the school or organization<\/label>\n<select id=\"Experience.-None-.records.RepeatingSectionControlMagicString.685000000057003\" name=\"Experience.-None-.records.RepeatingSectionControlMagicString.685000000057003\"><option selected=\"selected\" value=\"\"><\/option>\n<option value=\"Employment\">Employment<\/option>\n<option value=\"Voluntary Work\">Voluntary Work<\/option>\n<option value=\"Internship\">Internship<\/option>\n<option value=\"Extracurricular Activities\">Extracurricular Activities<\/option>\n<\/select>\n<script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addSingleSelectValidator(\"Experience.-None-.records.RepeatingSectionControlMagicString.685000000057003\", \"Please select 1 item\", { isReqFunc: true });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n<\/li>\n<li class=\"control-child-wrapper\"><div id=\"IWDF-control-20\" class=\"form-control hidden field-control\"><label class=\"top\">CEEB Code<\/label>\n<input id=\"Experience.-None-.records.RepeatingSectionControlMagicString.685000000002975\" maxlength=\"10\" name=\"Experience.-None-.records.RepeatingSectionControlMagicString.685000000002975\" value=\"\" type=\"text\" readonly=\"readonly\"\/><\/div>\n<\/li>\n<\/ul>\n<script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.InlineLookup.bind(\"Experience.-None-.records.RepeatingSectionControlMagicString.685000000002963\", {\"lookupType\":\"organizations\",\"orgLookupFilter\":[]}, function(field, oneResult) { _IW.FormsRuntime.inlineLookupSelected(field, oneResult, \"685000000002963\"); }, { });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n");
// ]]>
</script>
							...
							<li class="page-child-wrapper" style="display:none">
								<div id="IWDF-control-27-null" class="form-control page-child">
									<div id="IWDF-wrapper-39">
										<div id="IWDF-control-27-IWDF-row-41" sectiontitle="Connections" style="margin-bottom:10px;" class="form-control section-control">
											<div class="title clearfix">
												<span>Connections</span>
												<a style="display:inline;float:right;" class="right-link right-link" onclick="_IW.FormsRuntime.removeSection(&quot;IWDF-control-27-IWDF-row-41&quot;, &quot;IWDF-link-40&quot;)" href="javascript:void(0)">Remove Entry</a>
											</div>
											<ul class="control-child-helper control-draggable clearfix wide">
												<li class="clear-float"></li>
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-29" class="form-control field-control">
														<label class="dynamic-form-required top">* Last Name</label>
														<input id="Connections.-None-.records.IWDF-row-41.685000000003017" maxlength="80" name="Connections.-None-.records.IWDF-row-41.685000000003017" value="<?php echo ($stdt_lname);?>" type="text" />
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Connections.-None-.records.IWDF-row-41.685000000003017", "notEmpty", null, { trim: true, isReqFunc: true, disabled: true });
// ]]>
</script>
													</div>
												</li>
												...
												<li class="clear-float"></li>
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-33" class="form-control field-control">
														<label class="top">Email</label>
														<input id="Connections.-None-.records.IWDF-row-41.685000000003021" maxlength="100" name="Connections.-None-.records.IWDF-row-41.685000000003021" value="<?php echo ($stdt_eml);?>" type="text" />
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Connections.-None-.records.IWDF-row-41.685000000003021", "validEmail", null, { trim: true, emptyvalid: true });
// ]]>
</script>
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("Connections.-None-.records.IWDF-row-41.685000000003021", "notEmpty", null, { trim: true, isReqFunc: true, disabled: true });
// ]]>
</script>
													</div>
												</li>
												<li class="control-child-wrapper">
													<div id="IWDF-control-31" class="form-control hidden field-control">
														<label class="dynamic-form-required top">* Connection Type</label>
														<select id="Connections.-None-.records.IWDF-row-41.685000000029363" name="Connections.-None-.records.IWDF-row-41.685000000029363" disabled="disabled">
															<option value=""></option>
															...
															<option selected="selected" value="Advisor to Student">Advisor to Student</option>
														</select>
													</div>
												</li>
											</ul>
									...
									<div style="text-align:right;">
										<a id="IWDF-link-40" style="display:inline;font-weight:bold;" onclick="_IW.FormsRuntime.duplicateSection(&quot;IWDF-wrapper-39&quot;, &quot;Connections.-None-&quot;)" href="javascript:void(0)">Add Another Response</a>
									</div>
									<script type="text/javascript">
// <![CDATA[
_IW.FormsRuntime.setTemplate("Connections.-None-", "<div id=\"IWDF-control-27-RepeatingSectionControlMagicString\" sectionTitle=\"Connections\" style=\"margin-bottom:10px;\" class=\"form-control section-control\"><div class=\"title clearfix\"><span>Connections<\/span>\n<a style=\"display:inline;float:right;\" class=\"right-link\" onclick=\"_IW.FormsRuntime.removeSection(&quot;IWDF-control-27-RepeatingSectionControlMagicString&quot;, &quot;IWDF-link-40&quot;)\" href=\"javascript:void(0)\">Remove Entry<\/a>\n<\/div>\n<ul class=\"control-child-helper control-draggable clearfix wide\"><li class=\"clear-float\"><\/li>\n<li class=\"control-draggable control-child-wrapper\"><div id=\"IWDF-control-29\" class=\"form-control field-control\"><label class=\"dynamic-form-required top\">* Last Name<\/label>\n<input id=\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000003017\" maxlength=\"80\" name=\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000003017\" value=\"\" type=\"text\"\/><script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addTextFieldValidator(\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000003017\", \"notEmpty\", null, { trim: true, isReqFunc: true });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n<\/li>\n<li class=\"clear-float\"><\/li>\n<li class=\"control-draggable control-child-wrapper\"><\/li>\n<li class=\"clear-float\"><\/li>\n<li class=\"control-draggable control-child-wrapper\"><div id=\"IWDF-control-33\" class=\"form-control field-control\"><label class=\"top\">Email<\/label>\n<input id=\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000003021\" maxlength=\"100\" name=\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000003021\" value=\"\" type=\"text\"\/><script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addTextFieldValidator(\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000003021\", \"validEmail\", null, { trim: true, emptyvalid: true });\n\/\/ ]]&gt;\n<\/script>\n<script type=\"text\/javascript\">\n\/\/ <![CDATA[\n_IW.FormValidator.addTextFieldValidator(\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000003021\", \"notEmpty\", null, { trim: true, isReqFunc: true, disabled: true });\n\/\/ ]]&gt;\n<\/script>\n<\/div>\n<\/li>\n<li class=\"control-child-wrapper\"><div id=\"IWDF-control-31\" class=\"form-control hidden field-control\"><label class=\"dynamic-form-required top\">* Connection Type<\/label>\n<select id=\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000029363\" name=\"Connections.-None-.records.RepeatingSectionControlMagicString.685000000029363\" disabled=\"disabled\"><option value=\"\"><\/option>\n<option value=\"Parent to Child\">Parent to Child<\/option>\n<option value=\"Child to Parent\">Child to Parent<\/option>\n<option value=\"Sibling to Sibling\">Sibling to Sibling<\/option>\n<option value=\"Friend to Friend\">Friend to Friend<\/option>\n<option value=\"Emergency Contact to Emergency Contact\">Emergency Contact to Emergency Contact<\/option>\n<option value=\"Colleague to Colleague\">Colleague to Colleague<\/option>\n<option value=\"Spouse to Spouse\">Spouse to Spouse<\/option>\n<option value=\"Guardian to Dependant\">Guardian to Dependant<\/option>\n<option value=\"Dependant to Guardian\">Dependant to Guardian<\/option>\n<option value=\"Parent to Parent\">Parent to Parent<\/option>\n<option value=\"Teacher to Student\">Teacher to Student<\/option>\n<option selected=\"selected\" value=\"Advisor to Student\">Advisor to Student<\/option>\n<\/select>\n<\/div>\n<\/li>\n<\/ul>\n<\/div>\n");
// ]]>
</script>
				...
				<fieldset>
                    <legend>Recommendation Upload(s)</legend>
                    <p><strong>If you have not already completed the Recommendation Form, please first check the email that directed you to this page for instructions.</strong></p>
                    <div style="width:880px; height:300px">
                    	<div class="ifbox">
                        	<strong>Recommendation Form</strong><br />
                    	...
                    	<div class="ifbox">
                        	<strong>If you wrote a separate recommendation letter, upload that here.</strong><br />
							<iframe name="uploadFrame2" id="uploadFrame2" src="upload2.php?stdt_lname=<?php echo($stdt_lname); ?>&stdt_eml=<?php echo($stdt_eml); ?>" frameborder="0" height="250" scrolling="no" width="430" style="float:left"></iframe>
                        </div>
					</div>
			    </fieldset>

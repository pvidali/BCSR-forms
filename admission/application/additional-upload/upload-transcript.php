						...
						<ul class="page-child-helper">
							<li class="page-child-wrapper">
								<div id="IWDF-control-12" sectiontitle="Contact Attachments" class="form-control section-control page-child">
									<p style="text-indent: 10px"><strong>Transcript &amp; Supporting Documents</strong></p>
...
-->
			...
			<div id="IWDF-dialog-14" title="Please select your file" style="display:none;">
				<form enctype="multipart/form-data" target="IWDF-frame-15" method="post">
					...
					<p></p>
					<input style="width:100%;" name="description" type="hidden" value="Transcript &amp; Supporting Docs, upload 1" />
					...
					<input name="inquiryFormId" value="685000007346087" type="hidden" />
					<input name="domainObjectId" value="685000007346087" type="hidden" />
				</form>
			</div>
			<script type="text/javascript">
// <![CDATA[

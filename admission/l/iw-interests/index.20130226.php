...
// ]]>
										...
										<div id="IWDF-control-20" class="form-control field-control" style="margin-left: 10px;margin-top: 10px;">
											...
											<label for="getParentInfo" style="width:auto; margin: 5px 0; font-size: 14px; font-weight: bold; text-align:left" class="left">Click here if you want us to send info to your parents about Simon's Rock</label>
										</div>
<!-- HIDDEN PARENT INFO -->

										<div class="form-control field-control" style="display: none; width: auto !important; margin: 5px; border: 1px solid #000; min-height:265px; border-radius:10px; background:#DADADA" id="parentDiv">

...
<div id="container">
  <div id="content">
	<div id="main">
	<div id="form-wrapper" style="padding-left:0;margin-right:auto;width:455px; min-height:669px; margin-left:auto; border: 1px solid #000" class="ui-tabs-left">
		<form id="request" name="request" method="post" action="<?php echo($_SERVER['PHP_SELF']); ?>" onSubmit="return checkForm()" >
			<div id="IWDF-dynamicform-49" class="dynamicFormDefaults clearfix">
				<div id="IWDF-page-50">
					<div class="dynamic-form-required legend" style="font-size: 14px; text-align: left; padding: 10px 10px 10px 0;">Use this form to tell us about your interests.</div>
...
// ]]>
										...
										<div id="IWDF-control-20" class="form-control field-control" style="margin-left: 10px;">
											...
											<label for="getParentInfo" style="width:auto; text-align:left" class="left">Check this if you want us to contact your parents/guardians</label>
										</div>
<!-- HIDDEN PARENT INFO -->

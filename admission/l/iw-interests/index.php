...
//			$iwFrame = makeIWShortFrame($postArray);
		...
		$formStr .= "&";
		$formStr .= "otherInterests=".$postArray['Contacts_685000000121543'];// other interests
		$formStr .= "&";
		$formStr .= "685000000112005=".$postArray['Contacts_685000000112005']; // other interests
		$formStr .= "&";
		$formStr .= "685000000112007=".$postArray['Contacts_685000000112007']; // other interests
		$formStr .= "&";
		$formStr .= "685000000112009=".$postArray['Contacts_685000000112009']; // other interests
		$formStr .= "&";
		$formStr .= "685000000296104=".$postArray['Contacts_685000000296104']; // other interests
		$formStr .= "&";
		$formStr .= "685000000296102=".$postArray['Contacts_685000000296102']; // other interests
		$formStr .= "&";
		$formStr .= "685000000296092=".$postArray['Contacts_685000000296092']; // other interests
		$formStr .= "&";
		$formStr .= "685000000121005=".$postArray['Contacts_685000000121005']; // other interests
		$formStr .= "&";
		$formStr .= "685000000296122=".$postArray['Contacts_685000000296122']; // other interests
		$formStr .= "&";
		$formStr .= "685000000296108=".$postArray['Contacts_685000000296108']; // other interests
		$formStr .= "&";
		$formStr .= "685000000296106=".$postArray['Contacts_685000000296106']; // other interests
		$formStr .= "&";
		$formStr .= "685000000296120=".$postArray['Contacts_685000000296120']; // other interests
		$formStr .= "&";
		$formStr .= "685000000296124=".$postArray['Contacts_685000000296124']; // other interests
		$formStr .= "&";
		$formStr .= "685000000296126=".$postArray['Contacts_685000000296126']; // other interests
		$formStr .= "&";
		$formStr .= "685000000296110=".$postArray['Contacts_685000000296110']; // other interests
...
label.left{width: 81px; font-size: 13px;}
...
// ]]>
									...
									<li class="control-draggable control-child-wrapper">
										...
										<div id="IWDF-control-14" class="form-control field-control">
											<label for="Contacts.685000000121543" class="left" style="width: auto; font-size: 14px; font-weight: bold;">Other interests <strong>not</strong> listed above</label>
...
// ]]>
								...
								<div id="IWDF-control-20" class="form-control field-control" style="margin-left: 10px;margin-top: 10px;">
									<input type="checkbox" name="getParentInfo" id="getParentInfo" onClick="toggleParentDiv(this.checked)" />
									<label for="getParentInfo" style="width:auto; margin: 5px 0; font-size: 14px; font-weight: bold; text-align:left" class="left">Also send my parents info about Simon's Rock.</label>
								</div>
								<!-- HIDDEN PARENT INFO -->
								<div class="form-control field-control" style="display: none; width: 630px !important; margin: 5px; border: 1px solid #000; min-height:265px; border-radius:10px; background:#DADADA" id="parentDiv">
									<label class="left" style="width:auto; vertical-align: top; font-size: 14px; font-weight: bold; border-bottom: 1px dashed; text-align:left">Parent/Guardian Info</label><br />
									<div style="float:left; width: 310px; margin-right: 5px; border-right: 1px gray dashed; margin-top: 9px;">
										...
										<ul class="control-child-helper control-draggable clearfix wide">
											<li class="control-draggable control-child-wrapper">
												<div id="IWDF-control-22" class="form-control field-control">
													<input style="margin-left:84px" id="Contacts.685000000296104" name="Contacts.685000000296104" value="on" type="checkbox" />
													<label for="Contacts.685000000296104" class="left" style="width:auto">Lives with student?</label>
												</div>
											</li>
											<li class="clear-float"></li>
											<li class="control-draggable control-child-wrapper">
												<div id="IWDF-control-16" class="form-control field-control">
													<label for="Contacts.685000000112005" class="left">Email</label>
	...
	// ]]>
											...
											<li class="control-draggable control-child-wrapper">
												<div id="IWDF-control-18" class="form-control field-control">
													<label for="Contacts.685000000112007" class="left">First Name</label>
	...
	// ]]>
											...
											<li class="control-draggable control-child-wrapper">
												<div id="IWDF-control-20" class="form-control field-control">
													<label for="Contacts.685000000112009" class="left">Last Name</label>
	...
	// ]]>
											...
											<li class="control-draggable control-child-wrapper">
												<div id="IWDF-control-24" class="form-control field-control">
													<label for="Contacts.685000000296102" class="left">Phone</label>
	...
	// ]]>
											...
											<li class="control-draggable control-child-wrapper">
												<div id="IWDF-control-26" class="form-control field-control">
													<label for="Contacts.685000000296092" class="left">Phone type</label>
	...
	// ]]>
											...
											<li class="control-draggable control-child-wrapper">
												<div id="IWDF-control-28" class="form-control field-control">
													<label for="Contacts.685000000121005" class="left">Relationship</label>
	...
	// ]]>
									...
									<div style="float:left; width: 310px; margin-top: 9px;">
										...
										<ul class="control-child-helper control-draggable clearfix wide">
											<li class="control-draggable control-child-wrapper">
												<div id="IWDF-control-36" class="form-control field-control">
													<input style="margin-left:84px;" id="Contacts.685000000296120" name="Contacts.685000000296120" value="on" type="checkbox" />
													<label for="Contacts.685000000296120" class="left" style="width:auto">Lives with student?</label>
												</div>
											</li>
											<li class="clear-float"></li>
											<li class="control-draggable control-child-wrapper">
												<div id="IWDF-control-30" class="form-control field-control">
													<label for="Contacts.685000000296122" class="left">Email</label>
	...
	// ]]>
											...
											<li class="control-draggable control-child-wrapper">
												<div id="IWDF-control-32" class="form-control field-control">
													<label for="Contacts.685000000296108" class="left">First Name</label>
	...
	// ]]>
											...
											<li class="control-draggable control-child-wrapper">
												<div id="IWDF-control-34" class="form-control field-control">
													<label for="Contacts.685000000296106" class="left">Last Name</label>
	...
	// ]]>
											...
											<li class="control-draggable control-child-wrapper">
												<div id="IWDF-control-38" class="form-control field-control">
													<label for="Contacts.685000000296124" class="left">Phone</label>
	...
	// ]]>
											...
											<li class="control-draggable control-child-wrapper">
												<div id="IWDF-control-40" class="form-control field-control">
													<label for="Contacts.685000000296126" class="left">Phone type</label>
	...
	// ]]>
											...
											<li class="control-draggable control-child-wrapper">
												<div id="IWDF-control-42" class="form-control field-control">
													<label for="Contacts.685000000296110" class="left">Relationship</label>

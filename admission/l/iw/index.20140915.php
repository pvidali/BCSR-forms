	...
	<div id="content">
		...
		<?php
			if(!(isset($_POST['submit']))){
				$rightFloat = 'right';
		?>
			<iframe src="http://forms.simons-rock.edu/admission/assetsnew/index.php" width="567" height="760" scrolling="no" style="border: 0; margin: 0; padding: 0; width: 564px;"></iframe>
		<?php
			}
			else{
				$rightFloat = 'none';

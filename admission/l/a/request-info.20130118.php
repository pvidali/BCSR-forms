...
<?
			...
			$email = $_POST['email'];
			$redirectStr = "http://forms.simons-rock.edu/admission/thankyou.php?email=$email&couns=$redir";
?>
          ...
          <button onClick="_gaq.push(['_trackEvent', 'Form', 'Submit', 'Slideshow LP Form 2'])" type="submit" name="submit" id="submit" style="margin-top:30px; margin-left:220px; ">Submit Survey</button>&nbsp; 

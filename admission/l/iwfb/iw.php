...
<input id="Contacts.685000000003015" name="Contacts.685000000003015" value="<?php echo($_REQUEST['Contacts_685000000003015']); ?>" type="hidden" />
<input id="Contacts.685000000003017" name="Contacts.685000000003017" value="<?php echo($_REQUEST['Contacts_685000000003017']); ?>" type="hidden" />
<input id="Contacts_685000000120167" name="Contacts.685000000120167" value="<?php echo($_REQUEST['Contacts_685000000120167']); ?>" type="hidden" />
<input id="Contacts.685000000003051" name="Contacts.685000000003051" value="<?php echo($_REQUEST['Contacts_685000000003051']); ?>" type="hidden" />
<input id="Contacts.685000000003063" name="Contacts.685000000003063" value="<?php echo($_REQUEST['Contacts_685000000003063']); ?>" type="hidden" />
<input id="Contacts.685000000003065" name="Contacts.685000000003065" value="<?php echo($_REQUEST['Contacts_685000000003065']); ?>" type="hidden" />
<input id="Contacts.685000000123120" name="Contacts.685000000123120" value="<?php echo($_REQUEST['Contacts_685000000123120']); ?>" type="hidden" />
<input id="Contacts.685000000003069" name="Contacts.685000000003069" value="<?php echo($_REQUEST['Contacts_685000000003069']); ?>" type="hidden" />
<input id="Contacts.685000000003067" name="Contacts.685000000003067" value="<?php echo($_REQUEST['Contacts_685000000003067']); ?>" type="hidden" />
<input id="Contacts.685000000003071" name="Contacts.685000000003071" value="<?php echo($_REQUEST['Contacts_685000000003071']); ?>" type="hidden" />
<input id="Contacts.685000000003021" name="Contacts.685000000003021" value="<?php echo($_REQUEST['Contacts_685000000003021']); ?>" type="hidden" />
<input id="Contacts.685000000003027" name="Contacts.685000000003027" value="<?php echo($_REQUEST['Contacts_685000000003027']); ?>" type="hidden" />
<input id="Contacts.685000000003033" name="Contacts.685000000003033" value="<?php echo($_REQUEST['Contacts_685000000003033']); ?>" type="hidden" />
<input id="Contacts.685000000110551" name="Contacts.685000000110551" value="<?php echo($_REQUEST['Contacts_685000000110551']); ?>" type="hidden" />
<input id="EducationHistory.High School.records.IWDF-row-53.685000000002963" name="EducationHistory.High School.records.IWDF-row-53.685000000002963" value="<?php echo($_REQUEST['EducationHistory_High_School_records_IWDF-row-53_685000000002963']); ?>" type="hidden" />
<input id="EducationHistory.High School.records.IWDF-row-53.685000000002993" name="EducationHistory.High School.records.IWDF-row-53.685000000002993" value="<?php echo($_REQUEST['EducationHistory_High_School_records_IWDF-row-53_685000000002993']); ?>" type="hidden" />
<!--
	<input id="EducationHistory.High School.records.IWDF-row-53.685000000003005" name="EducationHistory.High School.records.IWDF-row-53.685000000003005" value="<?php echo($_REQUEST['EducationHistory_High_School_records_IWDF-row-53_685000000003005']); ?>" type="hidden" />
-->
<input id="EducationHistory.High School.records.IWDF-row-53.685000000029103" name="EducationHistory.High School.records.IWDF-row-53.685000000029103" value="<?php echo($_REQUEST['EducationHistory_High_School_records_IWDF-row-53_685000000029103']); ?>" type="hidden" />
<input id="EducationHistory.High School.records.IWDF-row-53.685000000002975" name="EducationHistory.High School.records.IWDF-row-53.685000000002975" value="<?php echo($_REQUEST['EducationHistory_High_School_records_IWDF-row-53_685000000002975']); ?>" type="hidden" />
<input id="EducationHistory.High School.records.IWDF-row-53.685000000002997" name="EducationHistory.High School.records.IWDF-row-53.685000000002997" value="<?php echo($_REQUEST['EducationHistory_High_School_records_IWDF-row-53_685000000002997']); ?>" type="hidden" />
<input id="EducationHistory.High School.myType" name="EducationHistory.High School.myType" value="<?php echo($_REQUEST['EducationHistory_High_School_myType']); ?>" type="hidden" />
</form>
	<script type="text/javascript">
// <![CDATA[

			jQuery(function() { _IW.FormsRuntime.bootstrap(54, "IWDF-dynamicform-49", 685000000110077, {".doc":true,".css":true,".qt":true,".xlsb":true,".html":true,".xlw":true,".xlsm":true,".xls":true,".csv":true,".eps":true,".xlt":true,".txt":true,".tif":true,".rar":true,".dotm":true,".htm":true,".wk2":true,".wk3":true,".movie":true,".dotx":true,".tiff":true,".wk1":true,".xml":true,".rm":true,".bmp":true,".potx":true,".png":true,".xlam":true,".ppam":true,".mpeg":true,".jpg":true,".zip":true,".dat":true,".pptx":true,".docx":true,".potm":true,".gif":true,".wav":true,".pptm":true,".jpeg":true,".swf":true,".docm":true,".xltx":true,".xltm":true,".mpg":true,".avi":true,".pdf":true,".moov":true,".ppsx":true,".wpd":true,".ppsm":true,".ppt":true,".ani":true,".mov":true,".rtf":true,".xlsx":true}, {"MultiPage":false,"RequiresLogin":false}); });
...
<script type="text/javascript">
	//_IW.FormsRuntime.submit(document.iwsignup);
</script>
	</body>
</html>

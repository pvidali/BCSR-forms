...
// ]]>
		...
		<div id="form-wrapper" class="ui-tabs-left">
			...
			<form target="_dummy" name="iwsignup" action="javascript:void(0);">
				<div id="IWDF-dynamicform-21" class="dynamicFormDefaults clearfix">
					<ul>
						<li>
							<a href="#IWDF-page-22">Untitled Page</a>
						</li>
					</ul>
					<div id="IWDF-page-22">
									...
									<ul class="control-child-helper control-draggable clearfix wide">
										...
										<li class="control-draggable control-child-wrapper">
											<div id="IWDF-control-6" class="form-control field-control">
												...
												<input id="Contacts.685000000003015" maxlength="40" style="width:15em;" name="Contacts.685000000003015" value="<?php echo($_REQUEST['fname']); ?>" type="text" />
												<script type="text/javascript">
// <![CDATA[
...
// ]]>
							...
							<li class="page-child-wrapper">
								<div id="IWDF-control-10-null" class="form-control page-child">
									<div id="IWDF-wrapper-23">
										<div id="IWDF-control-10-IWDF-row-25" sectiontitle="School History" style="margin-bottom:10px;" class="form-control section-control">
											<div class="title clearfix">
												<span>School History</span>
												<a style="display:inline;float:right;" class="right-link right-link" onclick="_IW.FormsRuntime.removeSection(&quot;IWDF-control-10-IWDF-row-25&quot;, &quot;IWDF-link-24&quot;)" href="javascript:void(0)">Remove Entry</a>
											</div>
											<ul class="control-child-helper control-draggable clearfix wide">
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-12" class="form-control field-control">
														<label style="width:10em;" class="dynamic-form-required top">* High School Name</label>
														<input id="EducationHistory.High School.records.IWDF-row-25.685000000002963" maxlength="100" name="EducationHistory.High School.records.IWDF-row-25.685000000002963" value="<?php echo($_REQUEST['high_school']);?>" type="text" />
														<script type="text/javascript">
// <![CDATA[
_IW.FormValidator.addTextFieldValidator("EducationHistory.High School.records.IWDF-row-25.685000000002963", "notEmpty", null, { trim: true, isReqFunc: true });
// ]]>
</script>
													</div>
												</li>
												<li class="control-draggable control-child-wrapper">
													<div id="IWDF-control-14" class="form-control field-control">
														...
														<input id="EducationHistory.High School.records.IWDF-row-25.685000000029103" name="EducationHistory.High School.records.IWDF-row-25.685000000029103" value="on" type="checkbox" checked="checked" />
													</div>
												</li>
												<li class="clear-float"></li>
												...
												<li class="control-child-wrapper">
													<div id="IWDF-control-16" class="form-control hidden field-control">
														...
														<input id="EducationHistory.High School.records.IWDF-row-25.685000000002975" maxlength="10" name="EducationHistory.High School.records.IWDF-row-25.685000000002975" value="" type="text" readonly="readonly" />
													</div>
												</li>
												<li class="control-child-wrapper">
													<div id="IWDF-control-18" class="form-control hidden field-control">
														<label class="top">Primary State</label>
														<input id="EducationHistory.High School.records.IWDF-row-25.685000000002997" maxlength="30" name="EducationHistory.High School.records.IWDF-row-25.685000000002997" value="" type="text" readonly="readonly" />
													</div>
												</li>
												<li class="control-child-wrapper">
													<div id="IWDF-control-20" class="form-control hidden field-control">
														<label class="top">Education Type</label>
														<select id="EducationHistory.High School.records.IWDF-row-25.685000000056005" name="EducationHistory.High School.records.IWDF-row-25.685000000056005" disabled="disabled">
															<option value=""></option>

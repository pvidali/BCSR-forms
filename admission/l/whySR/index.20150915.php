...
<head>
  ...
  ================================================== -->
	...
	<style>
		...
		/* The video is forcing us to migrate the right column sooner */
...
<body>
	<div class="container">
		...
		<div class="eight columns">
			...
			?>
			<h1>Why Simon&rsquo;s Rock?</h1>
			<h3>Just Ask Pearl</h3>

            <iframe width="450" height="253" src="//www.youtube.com/embed/PZKAH4L7u50?rel=0" frameborder="0" allowfullscreen></iframe>
            
            <!--
            
            <br /><br />
            <h3 class="red">Skip High School. Go Directly to College.</h3>
            <p>Did you know you can start college at Simon's Rock now, before graduating high school, without taking the SATs?</p>
			...
			?>
				<h4><strong>5 Signs You&rsquo;re Ready for College Now</strong></h4>
 ...
 <?php
			...
			?>
			<h1>Why Now?</h1>
			<h3>5 Signs You&rsquo;re Ready for College Now</h3>
			<p><strong>Download the Early College Checklist to Find Out:</strong></p>
			<ul class="square">
				<li>If you're ready for a greater challenge now</li>
				<li>What you could be learning in college classes</li>
				<li>Some of the experiences awaiting you at The Early College</li>
			</ul>
            <h4>Request Info</h4>
<!-- 			<form id="request" name="request" method="post" action="<?php echo($_SERVER['PHP_SELF']); ?>" onSubmit="return checkForm()" > -->
			<form id="request" name="request" method="post" action="http://forms.simons-rock.edu/admission/l/5-signs-ready-for-college/index.php" onSubmit="return checkForm()" >
                	<fieldset>
...
-->
            ...
            <input name="URL" value="whySR" type="hidden">

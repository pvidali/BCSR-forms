...
//			$iwFrame = makeIWShortFrame($postArray);
			...
			$formStr .= "Contacts_685000000110319=".$postArray['Contacts_685000000110319']; // three words
			$formStr .= "&";
			$formStr .= "Contacts_685000000003013=".$postArray['Contacts_685000000003013']; // three words
			$formStr .= "&";
			$formStr .= "Contacts_685000000156005=".$postArray['Contacts_685000000156005']; // three words
//			echo $formStr;
//			exit();
...
function checkForm() {
	...
	if (document.layers||document.getElementById||document.all) {
        ...
        if (!rval) {
			...
			trackOutboundEvent('Form', 'Submit', 'Slideshow LP Short');
//			_gaq.push(['_trackOutboundEvent', 'Form', 'Submit', 'Slideshow LP Short']);
		}
        return rval
    } 
	else {

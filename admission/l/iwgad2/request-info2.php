...
<!-- --------------------- -->
          ...
          <button type="submit" name="submit" id="submit" style="margin-top:30px; margin-left:220px; ">Submit Survey</button> &nbsp; <a href="<?php echo($redirString);?>">No thanks, maybe later.</a>
          <div class="spacer"></div>

...
<head>
  ...
  ================================================== -->
	...
	<!-- CSS
  ================================================== -->
	<link rel="stylesheet" href="http://forms.simons-rock.edu/admission/l/5-signs-ready-for-college/stylesheets/base.css">
	<link rel="stylesheet" href="http://forms.simons-rock.edu/admission/l/5-signs-ready-for-college/stylesheets/skeleton.css">
	<link rel="stylesheet" href="http://forms.simons-rock.edu/admission/l/5-signs-ready-for-college/stylesheets/layout.css">
	...
	<!-- Favicons
	================================================== -->
	<link rel="icon" type="image/png" href="http://forms.simons-rock.edu/admission/l/5-signs-ready-for-college/images/favicon.png">
	<script type="text/javascript" src="http://forms.simons-rock.edu/js/form-funcs.js"></script>
</head>
<body>
<?php
if(! isset($_POST['submit']) ) {
...
?>
    ...
    <form id="request" name="request" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" onsubmit="return checkForm()">
        <fieldset>
            ...
            <input name="URL" value="<?php echo $_REQUEST['URL']?>" type="hidden">

...
<!-- 		<input id="Contacts.685000000003069" name="Contacts.685000000003069" value="<?php echo($_REQUEST['email']); ?>" type="hidden" /> -->
		...
		<input id="Cases.685000000003279" name="Cases.685000000003279" value="<?php echo($_REQUEST['three_words']); ?>" type="hidden" />
		<input id="Contacts.685000000110319" name="Contacts.685000000110319" value="ADG" type="hidden" />
		<input id="Contacts.685000000003013" name="Contacts.685000000003013" value="<?php ($lead_source); ?>" type="hidden" />

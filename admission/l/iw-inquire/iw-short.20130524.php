...
<!-- 		<input id="Contacts.685000000003069" name="Contacts.685000000003069" value="<?php echo($_REQUEST['email']); ?>" type="hidden" /> -->
		...
		<input id="Contacts.685000000110551" name="Contacts.685000000110551" value="<?php echo($_REQUEST['hs_gradyear']); ?>" type="hidden" />
		...
		<input id="Inquiries.Inquiry_Comment" name="Inquiries.Inquiry_Comment" value="<?php echo($_REQUEST['three_words']); ?>" type="hidden" />
		<input id="Contacts.685000000110319" name="Contacts.685000000110319" value="<?php echo($_REQUEST['Contacts.685000000110319']); ?>" type="hidden" />
		<input id="Contacts.685000000003013" name="Contacts.685000000003013" value="<?php echo($_REQUEST['Contacts.685000000003013']); ?>" type="hidden" />
		<input id="Contacts.685000000156005" name="Contacts.685000000155215" value="<?php echo($_REQUEST['Contacts.685000000155215']); ?>" type="hidden" />
												<script type="text/javascript">
// <![CDATA[

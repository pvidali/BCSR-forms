...
//	}
	...
	<script>
		ga('send', 'event', 'Form', 'Submit', '2013 FS - Over HS Animated LP');
    ...
    <div class="eleven columns" id="inner-container">
        ...
        <div class="row">  
            ...
            <div class="six columns">
                <h2>Simon's Rock At a Glance</h2>
                <ul class="list">
                	<li>400 Students</li>
            ...
            <div class="four columns">
                ...
                <div style="margin: 2px ; width: 250px; background: #fff; float: right; position: relative; top: -10px;">
                    <iframe width="245" height="470" frameborder="0" src="//forms.simons-rock.edu/admission/l/5-signs-ready-for-college/index.simple.php?URL=PACECHINESE" style="margin-left: 4px;"></iframe></div>


                <form id="request" name="request" method="post" action="<?php echo($_SERVER['PHP_SELF']); ?>" onSubmit="return checkForm()" style="display: none">
                	<fieldset>
...
?>
                        ...
                        <input id="texting_ok" name="texting_ok" type="checkbox" class="cb_left" style="clear:left">
                        <label for="texting_ok" class="cb_label" style="line-height: 20px;">May we contact you via text? </label>

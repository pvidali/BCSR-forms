...
// new date field name: 'orderdate'
	...
	if($formNum == '1'){
		$requiredFields = array("refemail","relationship","fname","lname","street_address","city","state","zip","high_school","high_school_state","anticipated_grad_year");
	...
	//		echo "$redirStr";
			...
			$body .= "                Referrer Email: " . $_POST['refemail']."\n";
			$body .= "       Relationship to student: " . $_POST['relationship']."\n";
			...
			$subj = "Info Request -- Student Referral";
			$doRedir = true;
		}

		$bad = "emeraldninjadragon@gmail.com";
		$from = $_POST['email'];
		if($from != $bad){
			$headers = "From: $from";
...
<div style="display: <?php echo($form1Display); ?>">
	...
	<div style="clear:both; float: left">
		  <label for="refemail">Referrer's e-mail<br />

		  <?php 
			if(isset($refemail_msg) && $refemail_msg == true){
				echo '<span class="small">Referrer\'s e-mail is required.</span>';
				$required = "errors";
			}
			else{
				$required = "";
		  ...
		  <input type="text" name="refemail" id="refemail" class="<?php echo($required); ?>" value="<?php echo($refemail);?>" /><span class="required">*</span>
	</div>
		  
	<div style="clear:both; float: left">
		  <label for="relationship">Relationship to student<br />

		  <?php 
			if(isset($relationship_msg) && $relationship_msg == true){
				echo '<span class="small">Relationship to student is required.</span>';
				$required = "errors";
			}
			else{
				$required = "";
		  ...
		  <input type="text" name="relationship" id="relationship" class="<?php echo($required); ?>" value="<?php echo($relationship);?>" /><span class="required">*</span>
	</div>		  

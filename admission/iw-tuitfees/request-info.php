...
//	$territoryInfo = getTerritoryInfo($territory,$territories);
	...
	if(!$test_env){
		...
		$formFrame = "<iframe src=\"http://forms.simons-rock.edu/admission/iw-tuitfees/iw-short.php?$formStr\" width=\"0\" height=\"0\" style=\"border: 0\"></iframe>";
	}
	echo $formFrame;
}
...
//	$redirStr = "http://www.simons-rock.edu/admission/thankyou/?email=$email&couns=$fields_recruiter";
	$redirStr = "http://forms.simons-rock.edu/admission/thankyou-iframe-counselor.php?email=$email&state=$state&country=$country";

?>
<script>
	ga('send', 'event', 'Form', 'Submit', 'Tuition and Fees Form');
	// _gaq.push(['_trackEvent', 'Form', 'Submit', 'Tuition and Fees Form']);
</script>
<?php
		//exit();
...
<div style="display: <?php echo($form1Display); ?>; border: 2px solid #696969; background: #1d75bb; float: right; -moz-border-radius: 10px; border-radius: 10px;padding: 10px 0;-moz-box-shadow:  #696969 3px 3px 3px; -webkit-box-shadow: #696969 3px 3px 3px; box-shadow:  #696969 3px 3px 3px; margin-right: 3px">
	<div id="righttop" style="width: 235px; height: auto !important; line-height: 18px !important; text-transform:none !important; font-size: 1.3em !important; margin-bottom: 10px; color:#fff !important; background: #1d75bb">
    	Questions about<br />paying for college?<br /><br />We have answers!
        <br />
        <hr style="color: #fff; width:150px; size:1px; margin: 10px 40px 7px">
        <hr style="color: #fff; width:150px; size:1px; margin: 5px 40px">
		<div style="font-weight:normal; padding: 5px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', Verdana, Arial, Helvetica, sans-serif; font-size: 13px !important; color: #2d2d2d;">
    		<div style="text-align:left; color: #fff; text-indent: 6px;">I prefer to be contacted by:</div>
            <div style="min-height: 25px" id="preferenceDiv">
              <form name="preferenceForm" id="preferenceForm">
                <div style="float:left; width:110px"><input type="radio" name="preference" id="preferenceEmail" value="email" onClick="showPreferred(this.value)" style="width: auto !important;"> <label for="preferenceEmail" style="color: #fff; font-size:13px">Email</label></div>
                <div style="float:left; width:110px"><input type="radio" name="preference" id="preferencePhone" value="phone" onClick="showPreferred(this.value)" style="width: auto !important;"> <label for="preferencePhone" style="color: #fff; font-size:13px">Phone</label></div>
			  </form>
		    </div>
        </div>
    </div>
							...
							<li class="page-child-wrapper first">
								<div id="IWDF-control-4" sectiontitle="Student Information" class="form-control section-control page-child first" style="border: none">
									<ul class="control-child-helper control-draggable clearfix wide" style="background:#1d75bb">
										<li class="control-draggable control-child-wrapper" id="fnameDiv" style="display:none">
											<div id="IWDF-control-6" class="form-control field-control">
												<label for="fname" style="width:18em; color: #fff" class="dynamic-form-required left">First name</label>
										...
										<li class="control-draggable control-child-wrapper" id="lnameDiv" style="display:none">
											<div id="IWDF-control-8" class="form-control field-control">
												<label for="lname" style="width:18em; color:#fff" class="dynamic-form-required left">Last name</label>
...
?>
										<li class="control-draggable control-child-wrapper" id="emailDiv" style="display:none">
											<div id="IWDF-control-8" class="form-control field-control">
												<label for="email" style="width:18em; color: #fff" class="dynamic-form-required left">Email</label>
...
?>
										...
										<li class="control-draggable control-child-wrapper" id="phoneDiv" style="display:none">
											<div id="IWDF-control-28" class="form-control field-control">
												<label for="phone" style="width:18em; color:#fff" class="left">Phone</label>
										...
										<li class="clear-float"></li>
										<li class="control-draggable control-child-wrapper" id="phonetypeDiv" style="display:none">
											<div id="" class="form-control field-control">
												<label for="phonetype" style="width:18em; color:#fff" class="left">Phone type:</label>
												<select id="phonetype" style="width:109px !important;min-width: 1em; background:#16bdde; border: 1px solid #fff; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; padding: 4px; -webkit-box-shadow: inset 2px 2px 2px 0px #333; -moz-box-shadow: inset 2px 2px 2px 0px #333; box-shadow: inset 2px 2px 2px 0px #333; color:#fff" name="phonetype">
													<option></option>
							...
							<li class="control-draggable control-child-wrapper wide" id="addressLI" style="height: auto; width:230px !important;-moz-border-radius: 10px;border-radius: 10px;">
								<div id="addressDiv" class="form-control field-control" style="margin-left: 10px; display:none">
									<div id="streetDiv" class="form-control field-control" style="padding: 0 !important;">
										<label for="street" style="width: 100px !important; color:#fff" class="left">Street</label>
										<input id="street" maxlength="50" style="width:100px !important;min-width: 1em; background:#16bdde; border: 1px solid #fff; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; padding: 4px; -webkit-box-shadow: inset 2px 2px 2px 0px #333; -moz-box-shadow: inset 2px 2px 2px 0px #333; box-shadow: inset 2px 2px 2px 0px #333; color:#fff" name="street" value="" type="text" />
									</div>
									<div id="street2Div" class="form-control field-control" style="padding: 0 !important;">
										<label for="street2" style="width: 100px !important; color:#fff" class="left">Street 2</label>
										<input id="street2" maxlength="50" style="width:100px !important;min-width: 1em; background:#16bdde; border: 1px solid #fff; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; padding: 4px; -webkit-box-shadow: inset 2px 2px 2px 0px #333; -moz-box-shadow: inset 2px 2px 2px 0px #333; box-shadow: inset 2px 2px 2px 0px #333; color:#fff" name="street2" value="" type="text" />
									</div>
									<div id="cityDiv" class="form-control field-control" style="padding: 0 !important;">
										<label for="city" style="width: 100px !important; color:#fff" class="left">City</label>
										<input id="city" maxlength="50" style="width:100px !important;min-width: 1em; background:#16bdde; border: 1px solid #fff; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; padding: 4px; -webkit-box-shadow: inset 2px 2px 2px 0px #333; -moz-box-shadow: inset 2px 2px 2px 0px #333; box-shadow: inset 2px 2px 2px 0px #333; color:#fff" name="city" value="" type="text" />
									</div>
...
?>
								<div id="stateDiv" class="form-control field-control" style="display:none">
									<label id="stateLabel" for="state" style="width:18em; color: #fff" class="left">State/Province:</label>
									<select id="state" style="width:109px !important;min-width: 1em; background:#16bdde; border: 1px solid #fff; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; padding: 4px; -webkit-box-shadow: inset 2px 2px 2px 0px #333; -moz-box-shadow: inset 2px 2px 2px 0px #333; box-shadow: inset 2px 2px 2px 0px #333; color:#fff" name="state" onChange="toggleCountryDiv()">
									  <option selected="selected" value=""></option>
...
?>
								...
								<div id="addressDiv3" class="form-control field-control" style="margin-left: 0px; display:none">
									<div id="countryDiv" class="form-control field-control" style="padding: 0 !important;">
										<label for="country" style="width:17em; color: #fff" class="left">Country</label>
											<select id="country" name="country" style="width:109px !important;min-width: 1em; background:#16bdde; border: 1px solid #fff; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; padding: 4px; -webkit-box-shadow: inset 2px 2px 2px 0px #333; -moz-box-shadow: inset 2px 2px 2px 0px #333; box-shadow: inset 2px 2px 2px 0px #333; color:#fff">
													<option selected="selected" value=""></option>
                            ...
                            <li class="control-draggable control-child-wrapper wide" id="questionDiv" style="display:none">
                                <div id="IWDF-control-106" class="form-control field-control">
                                    <label for="comment" style="width:180px !important; text-align: left; color:#fff; text-indent: 6px;" class="left">What is your question?</label>
                                    <textarea id="comment" cols="5" style="resize: none; width:220px;vertical-align: top; background:#16bdde; border: 1px solid #fff; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; padding: 4px; -webkit-box-shadow: inset 2px 2px 2px 0px #333; -moz-box-shadow: inset 2px 2px 2px 0px #333; box-shadow: inset 2px 2px 2px 0px #333; color:#fff" name="comment" rows="3"></textarea>
...
-->
				...
				<input name="Contacts_685000000156005" value="<?php echo($specify_source); ?>" type="hidden" />
				  ...
				  <input type="submit" name="submit" id="submit" value="Submit" style="border: 2px solid #fff; -moz-box-shadow:  #696969 3px 3px 3px; -webkit-box-shadow: #696969 3px 3px 3px; box-shadow:  #696969 3px 3px 3px; color:#fff; width:150px !important; font-size: 17px !important; font-weight:bold; -webkit-border-radius: 9px; -moz-border-radius: 9px; border-radius: 9px; clear: both; margin: 0 0 0 5px; width: 188px; height: 35px; background: #990020; cursor:pointer" onMouseOver="this.style.background='#fff'; this.style.color='#990020'" onMouseOut="this.style.background='#990020'; this.style.color='#fff'" />
<!--				  <button type="submit" name="submit" id="submit" style="clear: both; margin: 0 0 0 5px; width: 188px; height: 35px; background: url(/admission/images/submit.png); cursor:pointer" onMouseOver="this.style.background='url(/admission/images/submit-hover.png)'" onMouseOut="this.style.background='url(/admission/images/submit.png)'"></button> -->
				</div>
			</form>
...
function checkForm() {
	...
	if (document.layers||document.getElementById||document.all) {
		...
		// figure out which fields to require based on preference
		contactPreference = getCheckedValue(document.preferenceForm.elements['preference']);
		if(contactPreference == ""){
			document.getElementById('preferenceDiv').style.backgroundColor = highlight
            rval = false
		}
		else {
            document.getElementById('preferenceDiv').style.backgroundColor = normalDiv
		}
		...
		if (document.request.comment.value.length == 0) {
            document.request.comment.style.backgroundColor = highlight
            rval = false
			if(fieldFocus == ""){
				fieldFocus = "comment";
			}
            ...
            document.request.comment.style.backgroundColor = normal
		}	
        if (!rval) {

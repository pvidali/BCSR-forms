...
/* ]]> */
 	...
 	<body onload="_IW.FormsRuntime.submit(document.forms['iwsignup'])"> 
...
// ]]>
	...
	<form target="_dummy" name="iwsignup" action="javascript:void(0);">
		...
		<input id="Contacts.685000000003031" name="Contacts.685000000003031" value="<?php echo($_REQUEST['phone']); ?>" type="hidden" />

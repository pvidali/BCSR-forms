...
//	$redirStr = "http://forms.simons-rock.edu/admission/thankyou-iframe-counselor.php?email=$email&couns=$fields_recruiter";

echo "Recruiter: ".$fields_recruiter;
...
?>
<div style="display: <?php echo($form1Display); ?>; border: 2px solid #000; background: #FFF; float: right; -moz-border-radius: 10px; border-radius: 10px;padding-top: 10px;">
	<div id="righttop" style="width: 242px; height: auto !important; line-height: 18px !important; text-transform:none !important; font-size: 1.3em !important; ">
		...
		<div style="font-weight:normal; padding: 5px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', Verdana, Arial, Helvetica, sans-serif; font-size: 13px !important; color: #2d2d2d;">
    		<div style="text-align:left">I prefer to be contacted by:</div>
            <div style="min-height: 25px" id="preferenceDiv">
              <form name="preferenceForm" id="preferenceForm">
                <div style="float:left; width:110px"><input type="radio" name="preference" id="preferenceEmail" value="email" onClick="showPreferred(this.value)" style="width: auto !important;"> <label for="preferenceEmail">E-mail</label></div>
                <div style="float:left; width:110px"><input type="radio" name="preference" id="preferencePhone" value="phone" onClick="showPreferred(this.value)" style="width: auto !important;"> <label for="preferencePhone">Phone</label></div>
			  </form>
		    </div>
        </div>
    </div>

...
//	include $_SERVER['DOCUMENT_ROOT']."/includes/iw-curl.php";
	include "tempcurl.php";

	//include $redirStr;	
	?>
	<script>
        _gaq.push(['_trackEvent', 'Form', 'Submit', 'Thank you page Counselor Question']);
    </script>
                        ...
                        <div id="questionDiv" style="width:300px; padding-bottom: 35px;">
                           ...
                           <div id="counsDiv" style="display: <?php echo($counsDivDisplay) ?>">
                            ...
                            <div style="clear:both; height:2px"></div>
                          	<div id="lnameDiv" style="display: none"><label for=lname>Last name</label>:<br /><input id='lname' type='text' name='lname' value='<?php echo($lname)?>'></div>
                            <div style="clear:both; height:2px"></div>
                            <textarea id="question" name="Cases.685000000003279" style="margin-left: 10px;width: 210px; float: left; height: 54px;"></textarea>
                            <input type="hidden" name="formid" id="formid" value="685000007028041">
                            <input type="hidden" name="seed" id="seed" value="13">
                    		<button type="submit" name="submit" id="submit" >Ask!</button>

<!--
			                <button type="submit" name="submit" id="submit"  value="Ask!" style="border:1px solid #999; padding:6px 10px; font-size: 15px; cursor:pointer; "></button>
...
function checkForm() {
	...
	if (document.layers||document.getElementById||document.all) {
		...
		if (document.getElementById('question').value.length == 0) {
            document.getElementById('question').style.backgroundColor = highlight
            rval = false
			if(fieldFocus == ""){
				fieldFocus = "question";
			}
            ...
            document.request.question.style.backgroundColor = normal
		}		
		if (!rval) {

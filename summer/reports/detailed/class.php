...
//	$tableRows = array();
	...
	while($row = $db->fetchObject()) {
		...
		if(!in_array($contact_id,$unique_cids)){
			$show_tuition = true;
			$unique_cids[] = $contact_id;
		}
		else{
			$show_tuition = false;
		}
			...
			while($inner_row = $db2->fetchObject()) {
				...
				$tableRows .= "
					<tr class=\"$rowClass\">
						...
						<td valign='top'>$applicant_name</td>
						<td valign='top'>$permaddress_street";
						if(($permaddress_street2)!=""){
							$tableRows .= ", ".$permaddress_street2;
						}
						$tableRows .= "<br />
						$permaddress_city, $permaddress_state $permaddress_zip</td>
						<td valign='top'>$permaddress_phone</td>
						<td valign='top'>$guardian_phone_day</td>
						<td valign='top'>$guardian_name</td>
						<td valign='top'>$emergency_phone</td>
						<td valign='top'>$parent_email</td>
						<td valign='top'>$date</td>
						<td valign='top'>$this_tuition</td>
					</tr>";
				$rowNum++;
			}
		}
...
<table cellpadding="3" cellspacing="0">
	<tr>
		...
		<td width="195"><strong>Permanent Address</strong></td>
		...
		<td width="90"><strong>Tuition</strong></td>
	</tr>	
<?php
	echo ($tableRows);
?>

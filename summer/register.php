...
while($row = $db->fetchObject()){
	...
	// @dscheff - #20120531 update - cancel classes 3 and 10 (and 9, as of 06/05/2012)
	// @dscheff - #20120614 update - cancel classes 1 and 6
	$class_display = "";
	if($row->id == '3' || $row->id == '10' || $row->id == '9' || $row->id == '1' || $row->id == '6' || $row->id == '12'){
		$class_display = 'none';
	}
	
	if($week == 1){
		$week1 .= "<div class=\"classDivs\" id=\"" . $thisClassIdName . "Div\" style=\"display: ". $class_display ." \" >";
	...
	if($week == 2){
		$week2 .= "<div class=\"classDivs\" id=\"" . $thisClassIdName . "Div\" style=\"display: ". $class_display ." \" >";
	...
	if($week == 3){
		$week3 .= "<div class=\"classDivs\" id=\"" . $thisClassIdName . "Div\" style=\"display: ". $class_display ." \" >";
	...
	if($week == 4){
		$week4 .= "<div class=\"classDivs\" id=\"" . $thisClassIdName . "Div\" style=\"display: ". $class_display ." \" >";

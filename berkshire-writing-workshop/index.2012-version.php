...
// 		if($member_discount == "yes" && $living_arrangement != "livingOffCampus"){
		...
		$sql = "INSERT INTO forms.bww_program_contact (id, date_submitted, applicant_name, permaddress_street, permaddress_street2, permaddress_city, permaddress_state, permaddress_zip,permaddress_country,permaddress_phone,cell_phone,email,hopes_info,vegetarian,living_arrangement,workshop,referral)  
		 		VALUES (NULL, now(), '$applicant_name', '$permaddress_street', '$permaddress_street2', '$permaddress_city', '$permaddress_state', '$permaddress_zip', '$permaddress_country', '$permaddress_phone', '$cell_phone', '$email', '$hopes_info', '$vegetarian', '$living_arrangement', '$workshop','$referral')";
		$db->do_query($sql);
...
<div id="innertop"></div>
	...
	<div style="clear:both;" id="student1Div">
		...
		<div style="margin: 10px 15px 10px 15px;" id="workshopDiv">
			...
			<input class="nofloatInput" type="radio" name="workshop" id="workshopMemoir" value="Memoir" disabled>  
			<label class="radiolabel" for="workshopMemoir">Memoir with Alison Lobron</label> <strong>(Class Filled. Please email <a href="mailto:alobron@simons-rock.edu">alobron@simons-rock.edu</a> to
be put on a waitlist.)</strong>
		</div>
        <div class="spacer"></div>
		...
		<div style="margin: 5px 15px 0 15px;" id="living_arrangementDiv">
			...
			<label class="radiolabel" for="livingOffCampus">Off-Campus: ($950)</label><br />

...
if(isset($_POST['submit'])) {
	...
	if($_POST['applicant_name'] == ""){
		...
		$bard_details			= safe($_POST["bard_details"]); 
...
// 		if($member_discount == "yes" && $living_arrangement != "livingOffCampus"){
		...
		if($mop == "paypal"){
			...
			$content = "
				...
				<p style=\"padding-bottom: 12px;\">Thank you for registering for the Berkshire Writing Workshop 2012 at Simon's Rock! Payment (\$$tuitionShow) is due in full at the time of registration. If, after registering, you discover you are unable to attend, refunds (less $100 administrative fee) will be issued for cancellations received in writing before <strong>June 1</strong>.</p>
...
//			$workshop			= $row->workshop;
			...
			$msg .= "                 Email: $email\n\n";
			$msg .= "    Grub Street member: $grubstreet\n\n";
			$msg .= "     SR Fac/Staff/Alum: $simonsrock\n\n";
			$msg .= "      Bard Affiliation: $bard\n\n";
			$msg .= "        Bard affiliate: $bard_details\n\n";
			...
			// now to customer
			$msg = "";
			$msg .= "Thank you for registering for the Berkshire Writing Workshop 2012 at Simon's Rock! Payment (\$$tuitionShow) is due in full at the time of registration. If, after registering, you discover you are unable to attend, refunds (less $100 administrative fee) will be issued for cancellations received in writing before June 1.\n\n";
...
<div id="innertop"></div>
	...
	<div style="clear:both;" id="student1Div">
		...
		<div style="display: none" id="bardDetailsDiv">
			<div class="spacer"></div>
			<div>Please tell us of your other Bard affiliation:  <input type="text" id="bard_details" style="float: none !important"></div>
		</div>

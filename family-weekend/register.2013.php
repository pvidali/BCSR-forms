...
$seniorThesisPanelAdults, $seniorThesisPanelChild, 
$studentShowcaseAdults, $studentShowcaseChild, 
$provostsReceptionAdults, $hikeUpMountainAdults, $hikeUpMountainChild, $fridayLunch, $fridayDinner, $saturdayBrunchAdults, 
$saturdayDinner, $sundayBrunch, $totalFamilyMembersAttending, NOW(), '$student1MeetingSpecifyWhich', '$student2MeetingSpecifyWhich', '$relative1Email', '$academicAdvisorMeeting1', '$academicAdvisorMeeting2', '$sophomoreFacultyMeeting1', '$sophomoreFacultyMeeting2','$SMLateArrival1','$arrivaldetails1','$SMLateArrival2','$arrivaldetails2','$seniorThesisAdvisorMeeting1','$seniorThesisAdvisorMeeting2')";
		$db->do_query($sql);
// 	echo ($sql);
// exit();	
/* --------------ADDED PAYAL ------------ 
...
-->
		...
		// student 1
		$msg .= "For $student1Fname $student1Lname you requested:\n";
		$prepend = "";
		if($academicAdvisorMeeting1 == ""){
			$prepend = " - No meeting";
		}
		else {
			$prepend = " - Meeting";
		...
		if($student1Class == "Sophomore"){
			...
			if($SMLateArrival1 == "on"){
				$msg .= "   (Requested this for Saturday morning b/w 10am and 12pm instead of Friday afternoon.)\n";
				if($arrivaldetails1 != ""){
		...
		if($student1Class == "Senior"){
			$prepend = "";
			if($seniorThesisAdvisorMeeting1 != ""){
		...
		// student 2
		$msg .= "\nFor $student2Fname $student2Lname you requested:\n";
		$prepend = "";
		if($academicAdvisorMeeting2 == ""){
			$prepend = " - No meeting";
		}
		else {
			$prepend = " - Meeting";
		...
		if($student2Meeting == "none") {
			...
			$msg .= "    Meetings with faculty (Specifically $student2MeetingSpecifyWhich\n\n";
		}
		else{
			$msg .= "    Meetings with faculty\n\n";
		}
		...
		if($student2Class == "Senior"){
			$prepend = "";
			if($seniorThesisAdvisorMeeting2 != ""){
				$msg .= "Senior Thesis Advisor meeting\n";
			}
			else {
				$msg .= "No Senior Thesis Advisor meeting\n";
		...
		$msg .= "\n\nIf you have registered for meetings with your student's faculty and academic advisor, please note that your schedule of actual meeting times between 10am and 1pm on Saturday, October 12, will be emailed to you after October 1st.\n\n";
		$msg .= "== ACTIVITIES ==\n\n";
...
//		}
		...
		if($mop == "paypal"){
			$msg .= "  (NOTE: Meal information below indicates only what you specified on the registration form, but does not itself indicate a successful payment. Successful payment confirmation will be emailed separately.)\n\n";
		}
		elseif ($mop == "cashAtDoor"){
			$msg .= "  (NOTE: Please remember to have cash with you. The Dining Hall can only accept cash.)\n\n";
		}
		if($total == "" || $total == 0 || $total == "0"){
		...
		$msg .= "Thank you again for registering for Bard College at Simon's Rock Family Weekend 2013. If you have any questions please do not hesitate to contact Cathy Ingram at cingram@simons-rock.edu or by phone at 413-528-7266.\n\n";
		$msg .= "We look forward to seeing you then!\n\n";
		// send email
		$to = $relative1Email;
		mail($to,"Family Weekend Registration Confirmation",$msg, "From: cingram@simons-rock.edu");
		$to = "dscheff@simons-rock.edu";
		mail($to,"COPY: Family Weekend Registration Confirmation",$msg, "From: cingram@simons-rock.edu");
...
$sophomoreNote = "Liz Lierman will be available, by appointment, to meet with sophomores and their parents to discuss the moderation and transfer process, as well as topics related to post-graduation plans. Please note that all Sophomore Planning Meetings will be scheduled on <strong>Friday, October 11, from 1:00 pm to 4:00 pm.</strong> For families not arriving until Saturday, there will be some appointments available on Saturday, October 12.";
?>
<!DOCTYPE HTML>
<html>
<head>
			...
			<div id="lateArrive1_div" style="clear:both; padding: 0 0 0 70px; display: inline-block; display: none ">
				<div>
					<input type="checkbox" name="SMLateArrival1" id="SMLateArrival1" class="radio" onClick="toggleDiv('SMLateArrival1','arrivaldetails_div')">
						<label for="SMLateArrival1" class="labelwide">Yes, I will be arriving late, and am unable to meet between 1pm and 4pm on Friday, and wish to on Saturday morning, between 10am and 12pm (if possible).</label></div>
	...
	<div style="clear:both; border: 1px solid #000; background:#F8F8F8; display: none" id="student2Div">
        ...
        <div style="clear: both; display:''" id="nonSophomoreFM2">
        	<div style="padding: 0 0 0 20px; font-weight: bold">
	        	...
	        	<div><strong>Faculty Meetings</strong></div>
			...
			<div id="lateArrive2_div" style="clear:both; padding: 0 0 0 70px;display: inline-block; display: none">
				<div>
					<input type="checkbox" name="SMLateArrival2" id="SMLateArrival2" class="radio" onClick="toggleDiv('SMLateArrival2','arrivaldetails2_div')">
						<label for="SMLateArrival2" class="labelwide">Yes, I will be arriving late, and am unable to meet between 1pm  and 4pm on Friday, and wish to meet on Saturday morning, between 10am and 12pm (if possible).</label></div>
...
?>
	...
	<div style="clear:both; padding:5px; margin:5px; ">
    	...
    	<div style="clear:both" id="seniorThesisPanelDiv">
	...
	<div style="clear:both; padding:5px; margin:5px; ">
		...
		<div>
			<div style="margin: 15px; font-size:13px">
            	Please indicate below which meals you plan to attend.</div>
		</div>
		<div>
...
<!--           <input style="margin-left: 150px;" type="checkbox" class="radio" name="cashAtDoor" id="cashAtDoor" onClick="doCashAtDoor(this.checked)"  /> -->
          ...
          <label style="text-align:left" for="paypal" class="labelmed">I will pay credit card now.</label>
        </div>

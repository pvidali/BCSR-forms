...
if(isset($_POST['submit'])) {
	...
	if($_POST['student1Fname'] == ""){
		...
		$sql = "INSERT INTO forms.family_weekend_2014 (
				...
				normanRockwellMuseumTransportationAdults, normanRockwellMuseumTransportationChild,
...
----------------------------------------- */
		...
		$sql = "SELECT id from forms.family_weekend_2014 ORDER BY id DESC LIMIT 1";
		$db->do_query($sql);
...
*/
		...
		$sql = "INSERT INTO forms.fw_program_meal_registration_2014 (contact_id, meals, payer_id, paid_for, date_submitted, mop)
				VALUES ($thisContactId,'$meals', $thisPayerId, '$paidfor', NOW(), '$mop')";
		$db->do_query($sql);
	
		$sql = "INSERT INTO forms.fw_meal_registration_2014 (contact_id,total) 
...
-->
		...
		$msg .= " - Interpretative Trail Guided Walk: $hikeUpMountainAdultsAdults Adult(s), $hikeUpMountainChild Child(ren)\n";
		$msg .= " - Piano Recital: $pianoRecitalAdults Adult(s), $pianoRecitalChild Child(ren)\n";
		$msg .= " - Norman Rockwell & Stockbridge Transportation: $normanRockwellMuseumTransportationAdults Adult(s), $normanRockwellMuseumTransportationChild Child(ren)\n";
		$msg .= " - Transportation to Stockbridge indiicated for: $walkingTourAdults Adult(s), $walkingTourChild Child(ren)\n";
...
//		}
		...
		if($total == "" || $total == 0 || $total == "0"){
			...
			$msg .= " - Saturday Brunch & Harvest Fest Lunch (\$9 per person): $saturdayLunch\n";
...
<!--		  <img src="info.png" onMouseOver="tooltip.show('Join us for a hike in one of our local parks.', 210);" onMouseOut="tooltip.hide();" style="float:left; padding: 2px 0 0 5px" /> -->
    	...
    	<div style="clear:both;" id="normanRockwellMuseumDiv">
          ...
          <input type="text" style="width: 50px" name="normanRockwellMuseumTransportationAdults" id="normanRockwellMuseumTransportationAdults" />
		  <input type="text" style="width: 50px" name="normanRockwellMuseumTransportationChild" id="normanRockwellMuseumTransportationChild" />
        </div>
    	<div style="clear:both;" id="normanRockwellMuseumDiv">
          <div>Great Barrington Historical Walking Tour</div>
          <label for="walkingTourAdults" class="labelmed">Will you need transportation?</label>

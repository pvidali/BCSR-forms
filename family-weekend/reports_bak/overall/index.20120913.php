...
//	$sql = "SELECT * FROM family_weekend WHERE relative1Class NOT LIKE '%Other%';";
	$sql = "SELECT * FROM family_weekend WHERE relative1Class LIKE '%Parent%' OR relative1Class LIKE '%Other%' OR relative1Class LIKE '%N/A%' AND relative1Fname !=''";
	$db->do_query($sql);
	$totalAdults += $db->numRows();

	$sql = "SELECT * FROM family_weekend WHERE relative2Class LIKE '%Parent%' OR relative2Class LIKE '%Other%' OR relative2Class LIKE '%N/A%' AND relative2Fname !=''";
	$db->do_query($sql);
	$totalAdults += $db->numRows();

	$sql = "SELECT * FROM family_weekend WHERE relative3Class LIKE '%Parent%' OR relative3Class LIKE '%Other%' OR relative3Class LIKE '%N/A%' AND relative3Fname !=''";
	$db->do_query($sql);
	$totalAdults += $db->numRows();

	$sql = "SELECT * FROM family_weekend WHERE relative4Class LIKE '%Parent%' OR relative4Class LIKE '%Other%' OR relative4Class LIKE '%N/A%' AND relative4Fname !=''";
	$db->do_query($sql);
	$totalAdults += $db->numRows();

	$sql = "SELECT * FROM family_weekend WHERE relative5Class LIKE '%Parent%' OR relative5Class LIKE '%Other%' OR relative5Class LIKE '%N/A%' AND relative5Fname !=''";
	$db->do_query($sql);
	$totalAdults += $db->numRows();
	
	$totalChildren = 0;
//	$sql = "SELECT * FROM family_weekend WHERE relative1Class NOT LIKE '%Other%';";
	$sql = "SELECT * FROM family_weekend WHERE relative1Class LIKE '%Child%'";
	$db->do_query($sql);
	$totalChildren += $db->numRows();

	$sql = "SELECT * FROM family_weekend WHERE relative2Class LIKE '%Child%'";
	$db->do_query($sql);
	$totalChildren += $db->numRows();

	$sql = "SELECT * FROM family_weekend WHERE relative3Class LIKE '%Child%'";
	$db->do_query($sql);
	$totalChildren += $db->numRows();

	$sql = "SELECT * FROM family_weekend WHERE relative4Class LIKE '%Child%'";
	$db->do_query($sql);
	$totalChildren += $db->numRows();

	$sql = "SELECT * FROM family_weekend WHERE relative5Class LIKE '%Child%'";
	$db->do_query($sql);
	$totalChildren += $db->numRows();

	$freshmenVisited = 0;
	$sql = "SELECT * FROM family_weekend WHERE student1Class LIKE '%First%'";
	$db->do_query($sql);
	$freshmenVisited += $db->numRows();
	$sql = "SELECT * FROM family_weekend WHERE student2Class LIKE '%First%'";
	$db->do_query($sql);
	$freshmenVisited += $db->numRows();

	$sophomoresVisited = 0;
	$sql = "SELECT * FROM family_weekend WHERE student1Class LIKE '%Soph%'";
	$db->do_query($sql);
	$sophomoresVisited += $db->numRows();
	$sql = "SELECT * FROM family_weekend WHERE student2Class LIKE '%Soph%'";
	$db->do_query($sql);
	$sophomoresVisited += $db->numRows();

	$juniorsVisited = 0;
	$sql = "SELECT * FROM family_weekend WHERE student1Class LIKE '%Jun%'";
	$db->do_query($sql);
	$juniorsVisited += $db->numRows();
	$sql = "SELECT * FROM family_weekend WHERE student2Class LIKE '%Jun%'";
	$db->do_query($sql);
	$juniorsVisited += $db->numRows();

	$seniorsVisited = 0;
	$sql = "SELECT * FROM family_weekend WHERE student1Class LIKE '%Sen%'";
	$db->do_query($sql);
	$seniorsVisited += $db->numRows();
	$sql = "SELECT * FROM family_weekend WHERE student2Class LIKE '%Sen%'";
	$db->do_query($sql);
	$seniorsVisited += $db->numRows();

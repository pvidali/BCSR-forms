...
//	$sql = "SELECT * FROM family_weekend WHERE relative1Class NOT LIKE '%Other%';";
	$sql = "SELECT * FROM family_weekend WHERE relative1Class LIKE '%Parent%' OR relative1Class LIKE '%Other%'";
	$db->do_query($sql);
	$totalAdults += $db->numRows();

	$sql = "SELECT * FROM family_weekend WHERE relative2Class LIKE '%Parent%' OR relative2Class LIKE '%Other%'";
	$db->do_query($sql);
	$totalAdults += $db->numRows();

	$sql = "SELECT * FROM family_weekend WHERE relative3Class LIKE '%Parent%' OR relative3Class LIKE '%Other%'";
	$db->do_query($sql);
	$totalAdults += $db->numRows();

	$sql = "SELECT * FROM family_weekend WHERE relative4Class LIKE '%Parent%' OR relative4Class LIKE '%Other%'";
	$db->do_query($sql);
	$totalAdults += $db->numRows();

	$sql = "SELECT * FROM family_weekend WHERE relative5Class LIKE '%Parent%' OR relative5Class LIKE '%Other%'";
	$db->do_query($sql);
	$totalAdults += $db->numRows();

...
//	$sql = "SELECT * FROM family_weekend ORDER BY student1Lname,student1Fname,student2Lname,student2Fname";
	$sql = "SELECT * FROM family_weekend ORDER BY date_submitted";
	$db->do_query($sql);
	$tablerows = "";
	$rowStyle = 0;
	$rowCount = 1;
	while($row = $db->fetchObject()) {
		...
		$tablerows .= "
			<tr class=\"$rowClass\">
				...
				<td>$studentClass</td>
				<td>$relativeLname, $relativeFname (<a href=\"mailto:$relativeEmail\">$relativeEmail</a>) </td>
				<td>$date</td>
...
<h2>Meeting Request Info</h2>

<table cellpadding="2" cellspacing="0">
	<tr>
		<td width="10">&nbsp;</td>
		<td width="175"><strong>Student</strong></td>
		<td width="60"><strong>Class</strong></td>
		<td width="175"><strong>Family Contact (email) </strong></td>
		...
		<td width="150" align="center"><strong>Late Arrival Info</strong></td>
	</tr>
<?php 
echo ($tablerows);
?>

...
<?php 		
	...
	$sql = "SELECT * FROM family_weekend WHERE date_submitted > '$rangestart' AND date_submitted < '$rangeend' ORDER BY date_submitted";
//	echo $sql;
	$db->do_query($sql);
	$tablerows = "";
	$rowStyle = 0;
	...
	while($row = $db->fetchObject()) {
		...
		$seniorThesisAdvisorMtg	= $row->seniorThesisAdvisorMeeting1;
		...
		$tablerows .= "
			<tr class=\"$rowClass\">
				...
				<td align=center>$seniorThesisAdvisorMtg</td>
		...
		if($row->student2Fname != ""){
			...
			$seniorThesisAdvisorMtg	= $row->seniorThesisAdvisorMeeting2;
			$relativeFname			= $row->relative1Fname;
			$relativeLname			= $row->relative1Lname;
			$relativeEmail			= $row->relative1Email;
...
<table cellpadding="3" cellspacing="0">
	<tr>
		...
		<td width="50" align="center"><strong>Thesis<br>Meeting?</strong></td>

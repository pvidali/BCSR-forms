...
*/
	...
	$sql = "SELECT * FROM family_weekend WHERE date_submitted > '$rangestart' AND date_submitted < '$rangeend' ORDER BY student1Lname,student1Fname,student2Lname,student2Fname";
	$db->do_query($sql);
	$tablerows = "";
	$rowStyle = 0;
	$rowCount = 1;

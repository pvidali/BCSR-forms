...
$FMNote = "Advanced registration for meetings with faculty and advisors has ended. If you would like to meet your student&#39;s faculty members, their meeting schedules will be posted on their office doors and when you arrive on campus, you can sign yourself up in an open time slot. If you have any questions, please email Karen Advokaat at <a href=\"mailto:kadvokaat@simons-rock.edu\">kadvokaat@simons-rock.edu</a>. Thank you.<br><br>Sophomore Planning Meetings are fully booked. If you would like to speak with James Jeffries, Director of Career Development, please email him at <a href=\"mailto:jjeffries@simons-rock.edu\">jjeffries@simons-rock.edu</a> to schedule a time to talk. Thank you.";
...
<html lang="en">
   <!--<![endif]-->
	...
	<head>
		...
		/* end pv */
		/* #20160908 pv */
		div.form-group.col-md-12 label { min-width: 55px; }
		</style>
...
<!--		  <img src="info.png" onMouseOver="tooltip.show('Five seniors will share their experiences during their study away program.', 210);" onMouseOut="tooltip.hide();" style="float:left; padding: 2px 0 0 5px" /> -->
    	...
    	<div class="form-group col-md-12" id="internationalFairDiv">
    		<h4>Author Reading</h4>

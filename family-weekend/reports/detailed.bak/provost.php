...
<html>
<head>
<title>Family Weekend 2011 Reports - Provost</title>
<style>
.rowOther {
...
<?php 
	...
	$sql = "SELECT * FROM family_weekend_2014 WHERE provostsReceptionAdults > 0 ORDER BY relative1Lname";
	$db->do_query($sql);
	$tablerows = "";
	$rowStyle = 0;
	$rowCount = 1;
...
<h2>Provost Reception Attendees</h2>

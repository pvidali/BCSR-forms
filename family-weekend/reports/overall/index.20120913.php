...
<?php 
	...
	$sql = "SELECT SUM(AlumniPanelAdults) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$AlumniPanelAdults = $res['SUM(AlumniPanelAdults)'];
	$sql = "SELECT SUM(AlumniPanelChild) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$AlumniPanelChild = $res['SUM(AlumniPanelChild)'];
	
	$sql = "SELECT SUM(FYAdjustmentAdults) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$FYAdjustmentAdults = $res['SUM(FYAdjustmentAdults)'];
	$sql = "SELECT SUM(FYAdjustmentChild) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$FYAdjustmentChild = $res['SUM(FYAdjustmentChild)'];
	
	$sql = "SELECT SUM(hikeUpMountainAdults) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$hikeUpMountainAdults = $res['SUM(hikeUpMountainAdults)'];
	$sql = "SELECT SUM(hikeUpMountainChild) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$hikeUpMountainChild = $res['SUM(hikeUpMountainChild)'];
	
	$sql = "SELECT SUM(honorsConvocationAdults) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$honorsConvocationAdults = $res['SUM(honorsConvocationAdults)'];
	$sql = "SELECT SUM(honorsConvocationChild) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$honorsConvocationChild = $res['SUM(honorsConvocationChild)'];
	
	$sql = "SELECT SUM(provostsReceptionAdults) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$provostsReceptionAdults = $res['SUM(provostsReceptionAdults)'];
	
	
	$sql = "SELECT SUM(studyAbroadPanelAdults) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$studyAbroadPanelAdults = $res['SUM(studyAbroadPanelAdults)'];
	$sql = "SELECT SUM(studyAbroadPanelChild) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$studyAbroadPanelChild = $res['SUM(studyAbroadPanelChild)'];
	
	$sql = "SELECT SUM(internationalFairAdults) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$internationalFairAdults = $res['SUM(internationalFairAdults)'];
	$sql = "SELECT SUM(internationalFairChild) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$internationalFairChild = $res['SUM(internationalFairChild)'];
	
	// meals
	$sql = "SELECT SUM(fridayLunchAdults) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$fridayLunchAdults = $res['SUM(fridayLunchAdults)'];
	$sql = "SELECT SUM(fridayLunchChild) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$fridayLunchChild = $res['SUM(fridayLunchChild)'];
	
	$sql = "SELECT SUM(fridayDinnerAdults) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$fridayDinnerAdults = $res['SUM(fridayDinnerAdults)'];
	$sql = "SELECT SUM(fridayDinnerChild) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$fridayDinnerChild = $res['SUM(fridayDinnerChild)'];
	
	$sql = "SELECT SUM(saturdayBrunchAdults) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$saturdayBrunchAdults = $res['SUM(saturdayBrunchAdults)'];
	$sql = "SELECT SUM(saturdayBrunchChild) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$saturdayBrunchChild = $res['SUM(saturdayBrunchChild)'];
	
	$sql = "SELECT SUM(saturdayDinnerAdults) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$saturdayDinnerAdults = $res['SUM(saturdayDinnerAdults)'];
	$sql = "SELECT SUM(saturdayDinnerChild) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$saturdayDinnerChild = $res['SUM(saturdayDinnerChild)'];
	
	$sql = "SELECT SUM(sundayBrunchAdults) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
	$sundayBrunchAdults = $res['SUM(sundayBrunchAdults)'];
	$sql = "SELECT SUM(sundayBrunchChild) FROM family_weekend";
	$db->do_query($sql);
	$res = $db->fetchArray();
...
//	$sql = "SELECT * FROM family_weekend_2014 WHERE relative1Class NOT LIKE '%Other%';";
	$sql = "SELECT * FROM family_weekend_2014 WHERE relative1Class LIKE '%Parent%' OR relative1Class LIKE '%Other%' OR relative1Class LIKE '%N/A%' AND relative1Fname !=''";
	$db->do_query($sql);
	$totalAdults += $db->numRows();

	$sql = "SELECT * FROM family_weekend_2014 WHERE relative2Class LIKE '%Parent%' OR relative2Class LIKE '%Other%' OR relative2Class LIKE '%N/A%' AND relative2Fname !=''";
	$db->do_query($sql);
	$totalAdults += $db->numRows();

	$sql = "SELECT * FROM family_weekend_2014 WHERE relative3Class LIKE '%Parent%' OR relative3Class LIKE '%Other%' OR relative3Class LIKE '%N/A%' AND relative3Fname !=''";
	$db->do_query($sql);
	$totalAdults += $db->numRows();

	$sql = "SELECT * FROM family_weekend_2014 WHERE relative4Class LIKE '%Parent%' OR relative4Class LIKE '%Other%' OR relative4Class LIKE '%N/A%' AND relative4Fname !=''";
	$db->do_query($sql);
	$totalAdults += $db->numRows();

	$sql = "SELECT * FROM family_weekend_2014 WHERE relative5Class LIKE '%Parent%' OR relative5Class LIKE '%Other%' OR relative5Class LIKE '%N/A%' AND relative5Fname !=''";
	$db->do_query($sql);
	$totalAdults += $db->numRows();
	
	$totalChildren = 0;
//	$sql = "SELECT * FROM family_weekend_2014 WHERE relative1Class NOT LIKE '%Other%';";
	$sql = "SELECT * FROM family_weekend_2014 WHERE relative1Class LIKE '%Child%'";
	$db->do_query($sql);
	$totalChildren += $db->numRows();

	$sql = "SELECT * FROM family_weekend_2014 WHERE relative2Class LIKE '%Child%'";
	$db->do_query($sql);
	$totalChildren += $db->numRows();

	$sql = "SELECT * FROM family_weekend_2014 WHERE relative3Class LIKE '%Child%'";
	$db->do_query($sql);
	$totalChildren += $db->numRows();

	$sql = "SELECT * FROM family_weekend_2014 WHERE relative4Class LIKE '%Child%'";
	$db->do_query($sql);
	$totalChildren += $db->numRows();

	$sql = "SELECT * FROM family_weekend_2014 WHERE relative5Class LIKE '%Child%'";
	$db->do_query($sql);
	$totalChildren += $db->numRows();

	$freshmenVisited = 0;
	$sql = "SELECT * FROM family_weekend_2014 WHERE student1Class LIKE '%First%'";
	$db->do_query($sql);
	$freshmenVisited += $db->numRows();
	$sql = "SELECT * FROM family_weekend_2014 WHERE student2Class LIKE '%First%'";
	$db->do_query($sql);
	$freshmenVisited += $db->numRows();

	$sophomoresVisited = 0;
	$sql = "SELECT * FROM family_weekend_2014 WHERE student1Class LIKE '%Soph%'";
	$db->do_query($sql);
	$sophomoresVisited += $db->numRows();
	$sql = "SELECT * FROM family_weekend_2014 WHERE student2Class LIKE '%Soph%'";
	$db->do_query($sql);
	$sophomoresVisited += $db->numRows();

	$juniorsVisited = 0;
	$sql = "SELECT * FROM family_weekend_2014 WHERE student1Class LIKE '%Jun%'";
	$db->do_query($sql);
	$juniorsVisited += $db->numRows();
	$sql = "SELECT * FROM family_weekend_2014 WHERE student2Class LIKE '%Jun%'";
	$db->do_query($sql);
	$juniorsVisited += $db->numRows();

	$seniorsVisited = 0;
	$sql = "SELECT * FROM family_weekend_2014 WHERE student1Class LIKE '%Sen%'";
	$db->do_query($sql);
	$seniorsVisited += $db->numRows();
	$sql = "SELECT * FROM family_weekend_2014 WHERE student2Class LIKE '%Sen%'";
	$db->do_query($sql);
	$seniorsVisited += $db->numRows();
...
<h1>Family Weekend 2011 Reports</h1>

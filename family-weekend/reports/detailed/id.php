...
<html>
<head>
<title>Family Weekend Registered Attendees</title>
<style>
.rowOther {
...
*/
	...
	$sql = "SELECT * FROM family_weekend_2015 WHERE date_submitted > '$rangestart' AND date_submitted < '$rangeend' ORDER BY id,student1Lname,student1Fname,student2Lname,student2Fname";
	$db->do_query($sql);
	$tablerows = "";
	$rowStyle = 0;
	$rowCount = 1;
...
<html>
<head>
<title>Family Weekend <?php echo($startyear);?> Report</title>
<style>
body{
...
<h1>Family Weekend <?php echo($startyear);?> Registered Attendees </h1>

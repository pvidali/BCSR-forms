...
//			if($is_faculty != "on" && $mop == "paypal"){
			if($mop == "paypal"){
				$paybuttons = '
					...
					<form name="paypalform2" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_parent">
					<input type="hidden" name="cmd" value="_xclick">
					<input type="hidden" name="business" value="3X4KTT5ATNBNA">
					<input type="hidden" name="lc" value="US">
					<input type="hidden" name="item_name" value="Summer Program 2012">
					...
					$contents = "<p>Redirecting to Paypal... please wait moment. If after 10 seconds the page has not taken you to Paypal, click the button below.</p>";
					$contents .= "<div>";
					$contents .= $paybuttons;
					$contents .= "</div>";
				echo ($contents);
...
function calculateRegistration(num){
	var costPerAdult = 50;
	var totalRegistration = num*costPerAdult;
	document.getElementById('registrationTotal').value = totalRegistration;
}
...
?>
<div id="innertop"></div>
	<p style="margin: 15px; font-size:16px"><strong>Simon’s Rock 45th Anniversary Reunion Registration</strong></p>
	<?php
...
?>
	...
	<div style="clear:both;" id="student1Div">
    	<div id="student1FnameDiv" style="display:none; clear:both">
    	...
    	<div style="clear:both" id="sr_yearDiv">
          <label for="sr_year">Simon's Rock Entry Year</label>
          <input type="text" name="sr_year" id="sr_year" /><span class="required">*</span>
        </div>
        <div style="clear:both; margin-left: 15px;"><strong>Mailing Address</strong></div>
...
<!-- FINISH GUESTS -->
        ...
        <div style="clear:both" id="emergency_relationshipDiv">
          <label for="emergency_relationship">Emergency contact name</label>
          <input type="text" name="emergency_relationship" id="emergency_relationship"
		  <?php
		  	if(isset($emergency_relationship)){
				echo (" value=\"$emergency_relationship\" ");
			}
		  ?>
		   /><span class="required">*</span>
        </div>
        ...
        <div style="clear:both" id="emergency_phoneDiv">
          <label for="emergency_phone">Day phone</label>
        ...
        <div class="spacer"></div>		
        <div style="clear:both" id="emergency_phone2Div">
          <label for="emergency_phone2">Evening phone</label>
          <input type="text" name="emergency_phone2" id="emergency_phone2"
		  <?php
		  	if(isset($emergency_phone2)){
				echo (" value=\"$emergency_phone2\" ");
			}
		  ?>
		  /><span class="required">*</span>
        </div>
		...
		<div style="margin: 15px 15px 0 15px;">
			Registration Fee:  
				<select name="numOfAdults" id="numOfAdults" onChange="calculateRegistration(this.value)" style="width: 50px; float: none"> 
			...
			x $50 = $<input class="nofloatInput" type="text" name="registrationTotal" id="registrationTotal" readonly value="50"> 
		</div>
        <div class="spacer"></div>
		<div style="margin: 15px 15px 0 15px;">
